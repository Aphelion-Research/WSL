"""Test Him V2 zero-cost model on OOS."""
import sys
import pandas as pd
import numpy as np
...
print("=" * 60)
print("HIM V2 ZERO-COST MODEL OOS TEST")
print("=" * 60)
...
# Test at 0x costs
print("\n" + "=" * 60)
print("ZERO COST MODEL AT ZERO EXECUTION COSTS")
print("=" * 60)
...
# Test at 1x costs
print("\n" + "=" * 60)
print("ZERO COST MODEL AT REAL COSTS (1x)")
print("=" * 60)

real_cost = CostModel.xauusd_baseline()

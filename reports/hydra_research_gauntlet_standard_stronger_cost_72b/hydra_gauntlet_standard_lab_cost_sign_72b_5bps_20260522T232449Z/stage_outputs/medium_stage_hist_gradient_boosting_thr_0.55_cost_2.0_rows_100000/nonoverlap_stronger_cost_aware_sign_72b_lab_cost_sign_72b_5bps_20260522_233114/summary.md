...
- **Run ID:** `nonoverlap_stronger_cost_aware_sign_72b_lab_cost_sign_72b_5bps_20260522_233114`
- **Verdict:** `NO_EDGE`
...
- **Trade count:** 908
- **Win rate:** 0.5198
- **Avg trade return (net):** -0.000119
- **Total return (gross):** 0.073141
- **Total return (net):** -0.108459
- **Max drawdown:** -0.293090
- **Longs:** 438
- **Shorts:** 470
...
- **Best baseline return (net):** -0.096706
- **Excess over best baseline:** -0.011753

## Baselines Detail

- `always_long`: trades=917, win_rate=0.4962, return_net=-0.096706
- `always_short`: trades=917, win_rate=0.5038, return_net=-0.270094
- `momentum`: trades=0, win_rate=N/A, return_net=N/A
- `random_seed_0`: trades=917, win_rate=0.5082, return_net=-0.120267

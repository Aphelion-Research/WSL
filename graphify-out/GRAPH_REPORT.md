...
## Corpus Check
- Large corpus: 1422 files · ~889,639 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 37550 nodes · 45197 edges · 3673 communities (3509 shown, 164 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 1368 edges (avg confidence: 0.61)
- Token cost: 233,115 input · 22,884 output

## Community Hubs (Navigation)
- [[_COMMUNITY_Hydra CLI Commands|Hydra CLI Commands]]
- [[_COMMUNITY_Data Fetch Adapters|Data Fetch Adapters]]
- [[_COMMUNITY_RAGD C++ Backend|RAGD C++ Backend]]
- [[_COMMUNITY_DayBrain ML Models|DayBrain ML Models]]
- [[_COMMUNITY_Domdata Data Pipeline|Domdata Data Pipeline]]
- [[_COMMUNITY_Loader Discovery System|Loader Discovery System]]
- [[_COMMUNITY_DuckDB Storage Writer|DuckDB Storage Writer]]
- [[_COMMUNITY_Hydra Gauntlet Research Scripts|Hydra Gauntlet Research Scripts]]
- [[_COMMUNITY_Agent CLI Architecture|Agent CLI Architecture]]
- [[_COMMUNITY_Signal Validation Baselines|Signal Validation Baselines]]
- [[_COMMUNITY_Test Infrastructure|Test Infrastructure]]
- [[_COMMUNITY_RAGD Bridge Integration|RAGD Bridge Integration]]
- [[_COMMUNITY_Data Provider Layer|Data Provider Layer]]
- [[_COMMUNITY_Dataset Registry Schema|Dataset Registry Schema]]
- [[_COMMUNITY_Loader Cache API|Loader Cache API]]
- [[_COMMUNITY_Causal Engine CLI|Causal Engine CLI]]
- [[_COMMUNITY_Loader CLI Commands|Loader CLI Commands]]
- [[_COMMUNITY_Dominion AI Retrieval|Dominion AI Retrieval]]
- [[_COMMUNITY_Stationary Features|Stationary Features]]
- [[_COMMUNITY_Manifest SQL Schema|Manifest SQL Schema]]
...
1. `Manifest` - 111 edges
2. `skills` - 101 edges
3. `ScoredChunk` - 71 edges
4. `AgentStore` - 70 edges
5. `Ignore` - 65 edges
6. `RagdBridge` - 54 edges
7. `str` - 54 edges
8. `RetrievalPlan` - 51 edges
9. `Cache` - 47 edges
10. `Source` - 45 edges

## Surprising Connections (you probably didn't know these)
- `ModelConfig` --uses--> `Pipeline`  [INFERRED]
  scripts/agent_prime_train_eval.py → data_pipeline/pipeline.py
- `str` --uses--> `Pipeline`  [INFERRED]
  scripts/agent_prime_train_eval.py → data_pipeline/pipeline.py
- `bool` --uses--> `Pipeline`  [INFERRED]
  scripts/agent_prime_train_eval.py → data_pipeline/pipeline.py
- `int` --uses--> `Pipeline`  [INFERRED]
  scripts/agent_prime_train_eval.py → data_pipeline/pipeline.py
- `Path` --uses--> `Pipeline`  [INFERRED]
  scripts/agent_prime_train_eval.py → data_pipeline/pipeline.py

## Hyperedges (group relationships)
- **RAGD Maintenance Test Suite** — tests_test_maintenance_report_test_report_empty_db, tests_test_maintenance_report_test_duplicate_detection_and_dry_run, tests_test_maintenance_report_test_apply_marks_deleted [EXTRACTED 1.00]
- **Forbidden Token Scanner Flow** — domdata_check_no_trading_main, domdata_check_no_trading_scan_repo, domdata_check_no_trading_should_scan, domdata_check_no_trading_is_allowlisted [EXTRACTED 1.00]
- **** — live_green_plan, ragd_health_issue, vault_broken_links, defect_d09_orphan_chunks [INFERRED]
- **** — label_6b, label_12b, label_72b, baseline_metric_config [INFERRED]
- **** — baseline_ridge_model, baseline_random_forest_model, dataset_v1, label_6b [INFERRED]
- **** — defect_d01_deletion_propagation, defect_d02_query_metadata, defect_d09_orphan_chunks, phase_3_truth_final [INFERRED]
- **** — feature_stability_analysis, unstable_feature_real_gold, unstable_feature_zscore_10, unstable_feature_days_to_expiry [INFERRED]

## Communities (3673 total, 164 thin omitted)

### Community 0 - "Hydra CLI Commands"
Cohesion: 0.02
Nodes (123): build_parser(), cmd_backtest(), cmd_cpp_build(), cmd_cpp_run(), cmd_export(), cmd_predict(), cmd_report(), cmd_train() (+115 more)

### Community 1 - "Data Fetch Adapters"
Cohesion: 0.06
Nodes (90): FetchAdapter, FetchConfig, BrowserAdapter, _utc_now(), available_adapters(), default_config(), resolve_adapter(), RequestsAdapter (+82 more)

### Community 2 - "RAGD C++ Backend"
Cohesion: 0.05
Nodes (95): dead_zone_report_json(), int64_param(), int_param(), json_response(), parse_body(), run(), todo_from_json(), todo_json() (+87 more)

### Community 3 - "DayBrain ML Models"
Cohesion: 0.06
Nodes (37): DayBrain, Day brain — H1/H4 timeframe specialisation., H1/H4 medium-timeframe brain., Scalp brain — M1/M5 timeframe specialisation., M1/M5 fast-timeframe brain with all 12 base learners., Returns (signals, confidences)., ScalpBrain, Swing brain — D1/W1 timeframe specialisation. (+29 more)

### Community 4 - "Domdata Data Pipeline"
Cohesion: 0.06
Nodes (87): main, ArgumentParser, Any, bool, datetime, int, Path, str (+79 more)

### Community 5 - "Loader Discovery System"
Cohesion: 0.06
Nodes (89): DeleteResult, DiscoveredFile, discover(), DiscoveredFile, DiscoveryError, Ignore, object, Path (+81 more)

### Community 6 - "DuckDB Storage Writer"
Cohesion: 0.04
Nodes (65): DuckDBPyConnection, float, int, ndarray, str, bool, DataFrame, float (+57 more)

### Community 7 - "Hydra Gauntlet Research Scripts"
Cohesion: 0.10
Nodes (85): annotate_stage_row(), append_command(), as_float(), as_int(), base_row(), best_row(), can_run_more(), Config (+77 more)

### Community 8 - "Agent CLI Architecture"
Cohesion: 0.06
Nodes (83): build_agent_subparser(), cmd_agent(), _cmd_architecture_refresh(), _cmd_architecture_show(), _cmd_complexity_budget(), _cmd_complexity_report(), _cmd_conflict_check(), _cmd_dashboard() (+75 more)

### Community 9 - "Signal Validation Baselines"
Cohesion: 0.08
Nodes (63): add_baseline_columns(), baseline_returns(), best_baseline(), binary_domain(), build_momentum_positions(), build_warnings(), classification_metrics(), fail() (+55 more)

### Community 10 - "Test Infrastructure"
Cohesion: 0.07
Nodes (76): cmd_graph_foundation(), Foundation graph commands: stats, build., Profiler, ProfileSpan, bool, float, int, Path (+68 more)

### Community 11 - "RAGD Bridge Integration"
Cohesion: 0.04
Nodes (70): _batched(), DeleteResult, elapsed_s(), IngestResult, ok(), paths_failed(), bool, float (+62 more)

### Community 12 - "Data Provider Layer"
Cohesion: 0.06
Nodes (48): CoverageReport, DataProvider, FetchResult, NormalizeResult, QualityReport, Base data provider interface and report dataclasses., DuckDBProvider, DuckDB provider — reads from existing dominion.duckdb gold_master table. (+40 more)

### Community 13 - "Dataset Registry Schema"
Cohesion: 0.06
Nodes (63): column_names(), columns(), ColumnSpec, HydraRegistry, Simplified HYDRA 3,000-column registry. Uses sequential numbering to guarantee e, Get only available columns (trainable)., Get unavailable columns (placeholders)., Get reserved columns (future use). (+55 more)

### Community 14 - "Loader Cache API"
Cohesion: 0.06
Nodes (60): CacheHit, DiffClass, cache_get(), cache_put(), get_manifest_entry(), hw_probe(), iter_files(), list_changed_since() (+52 more)

### Community 15 - "Causal Engine CLI"
Cohesion: 0.05
Nodes (66): cmd_export(), cmd_run(), cmd_show(), main(), CLI for causal discovery engine., Show causal paths to gold., Run PC algorithm + transfer entropy computation., export_dag_to_json() (+58 more)

### Community 16 - "Loader CLI Commands"
Cohesion: 0.06
Nodes (52): cmd_cache(), cmd_loader_bench(), cmd_loader_ledger(), cmd_manifest(), cmd_scan(), cmd_scan_native(), _cmd_scan_python(), _native_scan_binary() (+44 more)

### Community 17 - "Dominion AI Retrieval"
Cohesion: 0.11
Nodes (53): AskResult, Token Budget Optimization, Heuristic Reranking Strategy, _retrieve_only_answer, _retrieve_pipeline, ask(), AssembledContext, bool (+45 more)

### Community 18 - "Stationary Features"
Cohesion: 0.07
Nodes (64): audit_stationarity(), build_stationary_features(), compute_atr_pct(), compute_autocorr(), compute_bb_position(), compute_drawdown_pct(), compute_feature_correlations(), compute_hurst() (+56 more)

### Community 19 - "Manifest SQL Schema"
Cohesion: 0.05
Nodes (45): ManifestEntry, bool, Connection, int, Path, Row, str, Durable manifest SQLite store for dominion_loader.  Stores per-file metadata: co (+37 more)

### Community 20 - "Community 20"
Cohesion: 0.07
Nodes (44): BaseHTTPRequestHandler, ClassDef, chunk_cpp(), _find_block_end(), chunk_go(), chunk_javascript(), chunk_python(), _class_body_without_methods() (+36 more)

### Community 21 - "Community 21"
Cohesion: 0.09
Nodes (60): acquire_lock(), _conflicts_with(), list_locks(), _new_lock_id(), AgentStore, bool, FileLock, int (+52 more)

### Community 22 - "Community 22"
Cohesion: 0.09
Nodes (53): FileInfo, build_vault(), _daily(), _file_note(), _frontmatter(), _indexes(), _purpose(), bool (+45 more)

### Community 23 - "Community 23"
Cohesion: 0.07
Nodes (49): is_open, BrokerSelfTestResult, msg, pass, calculate_pnl(), compute_accuracy(), compute_auc(), compute_balanced_accuracy() (+41 more)

### Community 24 - "Community 24"
Cohesion: 0.10
Nodes (45): build_features(), build_features_stationary(), check_leakage(), compute_metrics(), CostScenario, load_data_for_period(), main(), make_labels() (+37 more)

### Community 25 - "Community 25"
Cohesion: 0.09
Nodes (53): AgentStore, Public API facade for Dominion Agent OS.  All public entry points are here. Inte, Attempt RAGD health check and record event.      Returns dict with: ok, chunk_co, sync_ragd(), Dominion Agent OS — Python package root., create_task(), get_task(), list_tasks() (+45 more)

### Community 26 - "Community 26"
Cohesion: 0.06
Nodes (47): Purged walk-forward cross-validation., Generate expanding-window train/val/test index arrays.      Returns list of (tra, walk_forward_splits(), get_connection(), load_bars(), load_cot(), load_features(), load_macro() (+39 more)

### Community 27 - "Community 27"
Cohesion: 0.09
Nodes (40): ingest_from_ragd(), KGEdge, KGNode, KnowledgeGraph, int, Path, str, Repo knowledge graph data layer for dominion_loader (S02/F01).  SQLite tables: k (+32 more)

### Community 28 - "Community 28"
Cohesion: 0.06
Nodes (32): bool, str, RAGDBusClient, RAGDBusSync, WebSocket client for RAGD /bus endpoint., WebSocket client for RAGD event bus., Synchronous wrapper for bus client., Send message synchronously. (+24 more)

### Community 29 - "Community 29"
Cohesion: 0.08
Nodes (44): ComplexityMetrics, all_packages_report(), complexity_report(), _compute_score(), _count_broad_excepts(), _count_public_symbols(), _count_temp_adapters(), _count_todos() (+36 more)

### Community 30 - "Community 30"
Cohesion: 0.07
Nodes (39): backtest_metrics(), kelly_size(), Python reference backtester — oracle implementation., Run backtest on precomputed signals.      Args:         close: close prices, run_backtest(), Trade, callable, make_targets() (+31 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (7): int, get_strategy(), 40+ improvement strategies for the autonomous loop., Grid search over long/short thresholds., Get strategy by 0-based index, wrapping around., Strategy, threshold_tuning()

### Community 32 - "Community 32"
Cohesion: 0.07
Nodes (39): claim_task(), list_claims(), _new_claim_id(), AgentStore, bool, ClaimResult, object, str (+31 more)

### Community 33 - "Community 33"
Cohesion: 0.07
Nodes (44): Forbidden Token Scanning, _is_allowlisted(), main(), bool, int, Path, str, Return True if this path is allowlisted by name or path prefix (policy-driven). (+36 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (45): auc, avg_pnl_per_bar, balanced_accuracy, max_drawdown, net_return, sharpe, auc, avg_pnl_per_bar (+37 more)

### Community 35 - "Community 35"
Cohesion: 0.11
Nodes (41): avg_rr(), calmar_ratio(), compute_all(), max_drawdown(), profit_factor(), Performance metrics: Sharpe, Sortino, Calmar, PF, DD, WR, RR., sharpe_ratio(), sortino_ratio() (+33 more)

### Community 36 - "Community 36"
Cohesion: 0.06
Nodes (32): load(), RobustScaler with fit/apply separation and persistence., Percentile-based scaler (5th-95th by default)., RobustScaler, float, int, ndarray, Path (+24 more)

### Community 37 - "Community 37"
Cohesion: 0.12
Nodes (41): abandon_session(), end_session(), get_session(), _git_branch(), _git_commit(), heartbeat(), list_sessions(), _new_session_id() (+33 more)

### Community 38 - "Community 38"
Cohesion: 0.12
Nodes (39): Any, int, str, run_suite(), cmd_ask(), cmd_bench(), cmd_eval(), cmd_explain() (+31 more)

### Community 39 - "Community 39"
Cohesion: 0.07
Nodes (42): chunk_id_for(), hash_file(), HashResult, bool, int, Path, str, Content hashing and change detection for dominion_loader.  Policy (Approach C fr (+34 more)

### Community 40 - "Community 40"
Cohesion: 0.10
Nodes (41): compile_prompt(), AgentStore, int, PromptCompilation, str, _ragd_context(), Prompt compiler for Dominion Agent OS.  Generates task-specific, safety-aware, e, Compile a task-specific prompt.      Includes: mission, scope, conflict report, (+33 more)

### Community 41 - "Community 41"
Cohesion: 0.05
Nodes (43): BrokerStats, avg_confidence, avg_holding_bars, avg_kelly_risk_pct, avg_loss, avg_lot_size, avg_rr, avg_win (+35 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (42): AnomalyDetector, detect_price_anomaly, detect_source_divergence, detect_volume_anomaly, z_flag_, z_quarantine_, DriftResult, feature_name (+34 more)

### Community 43 - "Community 43"
Cohesion: 0.07
Nodes (36): bool, DataFrame, DatetimeIndex, float, int, ndarray, Series, str (+28 more)

### Community 44 - "Community 44"
Cohesion: 0.08
Nodes (42): created, dataset, models, random_forest, ridge, ratings, train, val (+34 more)

### Community 45 - "Community 45"
Cohesion: 0.08
Nodes (30): Data source availability status., SourceStatus, Test HYDRA matrix builder., Verify registry has exactly 3,000 columns., Check registry summary., Build a small matrix for testing., Test quality gates on small matrix., test_build_small_matrix() (+22 more)

### Community 46 - "Community 46"
Cohesion: 0.07
Nodes (37): builtin_rules(), export_policy(), _load_dominionignore(), policy_hash(), bool, int, object, Path (+29 more)

### Community 47 - "Community 47"
Cohesion: 0.05
Nodes (34): ConflictResult, byzantine_detected, quarantined_sources, resolved_price, FusionResult, anomaly_flag, confidence, fused_price (+26 more)

### Community 48 - "Community 48"
Cohesion: 0.08
Nodes (39): compute_all_metrics(), compute_ic(), compute_max_drawdown(), compute_profit_factor(), compute_sharpe(), compute_turnover(), compute_win_rate(), evaluate_model() (+31 more)

### Community 49 - "Community 49"
Cohesion: 0.08
Nodes (31): DataContract, DtypeContract, MonotonicTimeContract, NullContract, PointInTimeContract, Data contracts and validation for HYDRA dataset. Ensures point-in-time safety an, Check null fractions., Validates column dtypes. (+23 more)

### Community 50 - "Community 50"
Cohesion: 0.20
Nodes (39): DoctorDeps, Path, str, _check(), _check_active_manifest_without_chunks(), _check_cache_integrity(), _check_deleted_chunk_leaks(), _check_domdata_guard() (+31 more)

### Community 51 - "Community 51"
Cohesion: 0.05
Nodes (40): dead_zone, auto_scan_on_startup, scan_interval_hours, embedding, api_key_env, batch_size, cache_embeddings, model (+32 more)

### Community 52 - "Community 52"
Cohesion: 0.05
Nodes (39): macro, microstructure, other, price, regime, volatility, column_counts, features (+31 more)

### Community 53 - "Community 53"
Cohesion: 0.17
Nodes (39): build_lab(), candidate_specs(), CandidateSpec, compute_atr_pct(), cost_candidate_name(), cost_label_suffix(), cost_sign_label(), dry_run() (+31 more)

### Community 54 - "Community 54"
Cohesion: 0.05
Nodes (38): DatasetBuilderV2, add_targets, all_features_, build, build_features, build_micro_features, build_return_features, build_session_features (+30 more)

### Community 55 - "Community 55"
Cohesion: 0.10
Nodes (36): BenchResult, _git_commit(), list_suites(), p50(), p95(), p99(), _percentile(), Any (+28 more)

### Community 56 - "Community 56"
Cohesion: 0.07
Nodes (28): Feature computation engine., DataFrame, float, int, Path, Series, str, FeatureStore (+20 more)

### Community 57 - "Community 57"
Cohesion: 0.16
Nodes (38): build_equity_curve(), compute_trade_metrics(), fail(), find_column(), fit_train_only_transform(), fmt_metric(), Fold, generate_baseline_trades_always() (+30 more)

### Community 58 - "Community 58"
Cohesion: 0.15
Nodes (36): chunk_markdown(), _estimate_tokens(), _hash(), DocumentChunk, int, str, _sliding_chunks(), add_job() (+28 more)

### Community 59 - "Community 59"
Cohesion: 0.10
Nodes (38): build_all_features(), build_cpp_advanced_features(), build_cross_timeframe_features(), build_feature_manifest(), build_interaction_features(), build_microstructure_features(), build_return_features(), build_session_calendar_features() (+30 more)

### Community 60 - "Community 60"
Cohesion: 0.07
Nodes (21): Point-in-Time Safety, candle_body(), candle_body_ratio(), candle_close_loc(), candle_lower_wick(), candle_range(), candle_upper_wick(), PYBIND11_MODULE() (+13 more)

### Community 61 - "Community 61"
Cohesion: 0.09
Nodes (32): calculate_fixed_commission_pnl(), compute_classification_metrics(), compute_trading_metrics(), crash_handler(), elapsed(), find_best_threshold(), get_cpu_percent(), get_memory_mb() (+24 more)

### Community 62 - "Community 62"
Cohesion: 0.13
Nodes (26): chunk_by_id(), chunk_to_json(), _content_hash(), parse_chunk(), parse_chunks(), ping_latency(), Any, bool (+18 more)

### Community 63 - "Community 63"
Cohesion: 0.17
Nodes (28): EmbedConfig, EmbeddingCache, EmbedBatcher, EmbeddingCache, EmbedConfig, Embedding pipeline for RAGD chunks., chunk_text(), ChunkInput (+20 more)

### Community 64 - "Community 64"
Cohesion: 0.10
Nodes (29): Path, build_parser(), cmd_doctor(), cmd_run(), cmd_stats(), _json(), main(), ArgumentParser (+21 more)

### Community 65 - "Community 65"
Cohesion: 0.06
Nodes (30): BacktestConfig, capital, commission, horizon, kelly_frac, pos_cap, slippage, spread (+22 more)

### Community 66 - "Community 66"
Cohesion: 0.06
Nodes (34): TradeRecord, balance_after, commission, confidence, config, direction, drawdown_risk_multiplier, entry_bar (+26 more)

### Community 67 - "Community 67"
Cohesion: 0.07
Nodes (27): AlphaVantageSource, cache_path_, config_, fetch, COTSource, config_, fetch, DataSource (+19 more)

### Community 68 - "Community 68"
Cohesion: 0.07
Nodes (33): content, kind, mode, priority, q, tags, top_k, handoff_read (+25 more)

### Community 69 - "Community 69"
Cohesion: 0.06
Nodes (33): FoldResult, accuracy, auc, avg_mi, avg_pearson_ic, avg_spearman_ic, avg_stability, avg_turnover (+25 more)

### Community 70 - "Community 70"
Cohesion: 0.13
Nodes (30): Graph Attention Network (pure numpy implementation)., Simplified GAT for graph embeddings (numpy-only, single-layer)., SimpleGAT, assemble_features(), causal_features(), esn_features(), gat_features(), ic_filter() (+22 more)

### Community 71 - "Community 71"
Cohesion: 0.06
Nodes (32): Config, alphavantage_api_key, anomaly_z_flag, anomaly_z_quarantine, bus_url, cot_gold_code, cot_urls, duckdb_path (+24 more)

### Community 72 - "Community 72"
Cohesion: 0.12
Nodes (18): Pipeline, DataFrame, float, int, str, Update source health in DuckDB., Store raw data in gold_raw table., Fuse prices via Kalman filter bank with graceful degradation. (+10 more)

### Community 73 - "Community 73"
Cohesion: 0.25
Nodes (32): aggregate_worst(), baseline_thresholded_direction(), choose_columns(), choose_threshold(), chronological_events(), evaluate_config(), feature_importance(), feature_prefilter() (+24 more)

### Community 74 - "Community 74"
Cohesion: 0.13
Nodes (20): HNSWIndex, HNSWIndex, _meta_path(), Any, float, int, ndarray, Path (+12 more)

### Community 75 - "Community 75"
Cohesion: 0.06
Nodes (32): close_column, high_column, low_column, reason, available, candidate, cost_bps, created_utc (+24 more)
...
Cohesion: 0.06
Nodes (32): BrokerPosition, confidence, config_name, current_price, direction, drawdown_risk_multiplier, entry_bar, entry_price (+24 more)

### Community 78 - "Community 78"
Cohesion: 0.12
Nodes (29): cmd_build(), cmd_show(), main(), Build current graph snapshot., build_correlation_graph(), compute_isolation_score(), compute_node_centrality(), init_graph_schema() (+21 more)

### Community 79 - "Community 79"
Cohesion: 0.11
Nodes (22): float, int, Path, str, int, str, Path, Telemetry recorder — writes iteration packets, CSVs, curves. (+14 more)

### Community 80 - "Community 80"
Cohesion: 0.09
Nodes (28): bool, DataFrame, float, int, ndarray, str, compute_embargo_purge(), Generate walk-forward splits.          Returns:             List of (train_idx, (+20 more)

### Community 81 - "Community 81"
Cohesion: 0.20
Nodes (31): add_manifest(), asof_merge_panel(), build(), downcast_numeric(), family_nan_percent(), first_matching_column(), flatten_daily_columns(), infer_existing_family() (+23 more)

### Community 82 - "Community 82"
Cohesion: 0.10
Nodes (23): Ledger, LedgerEntry, int, Path, str, Multi-agent memory ledger writer for dominion_loader (S05).  Schema:   ledger_en, Append a ledger entry. Idempotent on (session_id, kind, content_hash)., Retrieve recent entries of a given kind. (+15 more)

### Community 83 - "Community 83"
Cohesion: 0.06
Nodes (30): ScanError, code, message, path, to_json, ScanFile, absolute_path, content_hash (+22 more)

### Community 84 - "Community 84"
Cohesion: 0.06
Nodes (31): best_config, avg_trade_return, best_baseline_name, best_baseline_return_net, command, cost_bps, dataset, excess_over_best_baseline (+23 more)
...
Cohesion: 0.10
Nodes (22): FeatureType, column_names(), columns(), ColumnSpec, FeatureType, HydraRegistry, HYDRA 3,000-column registry system. Exact allocation: A-Z4 feature blocks with s, Data source availability status. (+14 more)

### Community 94 - "Community 94"
Cohesion: 0.24
Nodes (26): cmd_graph(), _json(), main(), int, str, build_graph(), callees(), callers() (+18 more)

### Community 95 - "Community 95"
Cohesion: 0.08
Nodes (29): created, end, max, min, start, features, excluded, excluded_expected (+21 more)

### Community 96 - "Community 96"
Cohesion: 0.11
Nodes (27): from_string(), generate_cot_names(), generate_label_names(), generate_macro_names(), generate_ohlcv_names(), generate_placeholder_names(), generate_regime_names(), generate_reserved_names() (+19 more)

### Community 97 - "Community 97"
Cohesion: 0.07
Nodes (28): BusClient, connect, connected_, disconnect, handler_, is_connected, max_reconnect_delay_, reconnect_delay_ (+20 more)

### Community 98 - "Community 98"
Cohesion: 0.12
Nodes (27): _agent_os_summary(), build_dashboard(), build_next(), _complexity_warnings(), _doctor_quick(), _llm_status(), _next_action(), AgentStore (+19 more)

### Community 99 - "Community 99"
Cohesion: 0.18
Nodes (28): always_long(), always_short(), BaselineResult, best_baseline(), _compute_metrics(), _cost_per_trade(), mean_reversion(), model_beats_baselines() (+20 more)

### Community 100 - "Community 100"
Cohesion: 0.18
Nodes (28): DataFrame, float, int, Series, str, atr(), bollinger_bands(), candle_features() (+20 more)

### Community 102 - "Community 102"
Cohesion: 0.12
Nodes (26): _normalize_format(), bytes, str, Semantic diff classifier for dominion_loader (S04).  Classifies the delta betwee, Classify the semantic difference between old and new file content.      Conserva, Remove trailing whitespace per line, normalize line endings., Remove all indentation, trailing whitespace, and collapse blank lines., Remove comment blocks from text. Conservative: may miss exotic comment styles. (+18 more)

### Community 103 - "Community 103"
Cohesion: 0.15
Nodes (27): DataFrame, float, int, Series, compute_adf(), compute_all_price_features(), compute_autocorr(), compute_drawdown() (+19 more)

### Community 104 - "Community 104"
Cohesion: 0.09
Nodes (20): ABC, ndarray, float, int, ModelWrapper, ndarray, fit(), ModelWrapper (+12 more)

### Community 105 - "Community 105"
Cohesion: 0.18
Nodes (26): RAGD Chunk Deduplication, RAGD Maintenance, Any, ArgumentParser, bool, Connection, int, Namespace (+18 more)

### Community 106 - "Community 106"
Cohesion: 0.13
Nodes (24): check_conflicts(), _get_dirty_files(), _get_task_scope_files(), AgentStore, ConflictReport, str, Conflict oracle for Dominion Agent OS.  Predicts conflicts before an agent edits, Return set of files modified in git working tree. (+16 more)

### Community 107 - "Community 107"
Cohesion: 0.13
Nodes (26): build_features_stationary(), compute_atr(), compute_metrics(), CostScenario, create_walk_forward_folds(), load_data(), main(), make_labels_pct() (+18 more)

### Community 108 - "Community 108"
Cohesion: 0.11
Nodes (15): MT5Collector, bar_count_, bar_interval_sec_, heartbeat_sec_, max_runtime_sec_, out_root_, recent_ticks_, symbol_ (+7 more)

### Community 109 - "Community 109"
Cohesion: 0.07
Nodes (26): available, candidate, cost_bps, created_utc, dataset_path, details, available, dry_run_gauntlet_command (+18 more)
...
Cohesion: 0.15
Nodes (24): _check_forbidden_tokens_in_files(), _file_exists(), _has_pytest_evidence(), AgentStore, bool, ReviewReport, str, Adversarial review lane for Dominion Agent OS.  Runs structured checks on a comp (+16 more)

### Community 122 - "Community 122"
Cohesion: 0.13
Nodes (12): BrokerSimulator, account, commission_per_lot, equity_curve, gold_oz_per_lot, kelly_est, next_trade_id, open_positions (+4 more)

### Community 123 - "Community 123"
Cohesion: 0.16
Nodes (25): Ignore, Path, _collect(), _collect_all(), _null_tracer(), Tests for dominion_loader.discover., Empty directory produces no files., Files over max_bytes are skipped. (+17 more)

### Community 124 - "Community 124"
Cohesion: 0.08
Nodes (25): BusPublisher, Pipeline, bus_, compute_features, config_, cot_data_, current_run_, features_ (+17 more)

### Community 125 - "Community 125"
Cohesion: 0.12
Nodes (17): bool, datetime, float, KalmanFilter, KalmanFilterBank, str, Multi-source data fusion via Kalman filtering., Multi-timescale Kalman filter bank for price fusion. (+9 more)

### Community 126 - "Community 126"
Cohesion: 0.11
Nodes (18): bool, DataFrame, datetime, float, AnomalyDetector, int, Path, Series (+10 more)

### Community 127 - "Community 127"
Cohesion: 0.13
Nodes (25): build_features(), check_leakage(), compute_metrics(), CostScenario, load_data(), make_labels(), ModeConfig, predict_ensemble() (+17 more)

### Community 128 - "Community 128"
Cohesion: 0.12
Nodes (16): bind_timestamp(), from_iso8601(), get_last_run(), get_recent_anomalies(), get_timestamp(), load_fused_bars(), log_anomaly(), log_run_complete() (+8 more)

### Community 129 - "Community 129"
Cohesion: 0.12
Nodes (23): DataFrame, Path, str, TCA analytics and reporting., Compute cost heatmap by hour.      Args:         db_path: DuckDB path      Retur, Get waterfall breakdown for single trade.      Args:         db_path: DuckDB pat, Compute average cost by regime.      Args:         db_path: DuckDB path      Ret, regime_breakdown() (+15 more)

### Community 130 - "Community 130"
Cohesion: 0.10
Nodes (23): compute_attribution(), float, str, Cost attribution logic., Decompose execution cost into components.      Args:         decision_price: Pri, compute_benchmark_comparison(), load_sim_benchmark(), float (+15 more)

### Community 131 - "Community 131"
Cohesion: 0.13
Nodes (20): _dcg(), Any, bool, float, int, Path, str, _read_jsonl() (+12 more)

### Community 132 - "Community 132"
Cohesion: 0.08
Nodes (24): Storage, get_feature_importance, get_last_run, get_latest_report, get_recent_anomalies, impl_, init_schema, load_features (+16 more)

### Community 133 - "Community 133"
Cohesion: 0.09
Nodes (21): DataFrame, Path, DataFrame, datetime, float, brownian_bridge(), int, Main pipeline orchestrator. (+13 more)

### Community 134 - "Community 134"
Cohesion: 0.12
Nodes (16): bool, datetime, float, PipelineMonitor, int, Path, str, Health monitoring and anomaly detection. (+8 more)

### Community 135 - "Community 135"
Cohesion: 0.13
Nodes (21): analyze_impact(), _match_rules(), AgentStore, ImpactReport, str, Causal impact analyzer for Dominion Agent OS.  Maps changed files to required va, Return all rules whose prefix matches the filepath., Given changed files, predict what must be tested and what may break.      If tas (+13 more)

### Community 136 - "Community 136"
Cohesion: 0.16
Nodes (18): emit_span(), new_trace_id(), Any, float, Path, str, _redact(), span() (+10 more)

### Community 137 - "Community 137"
Cohesion: 0.18
Nodes (23): DataFrame, int, compute_all_microstructure_features(), compute_amihud(), compute_bipower_variation(), compute_corwin_schultz(), compute_jump_component(), compute_kyle_lambda() (+15 more)

### Community 138 - "Community 138"
Cohesion: 0.16
Nodes (11): LimitOrderBook, float, int, LOB state machine implementation., Get depth imbalance: (bid_depth - ask_depth) / (bid_depth + ask_depth)., Initialize LOB.          Args:             depth: Number of price levels to main, Get current book state as dict., Update bid side.          Args:             price: Bid price             size: B (+3 more)

### Community 139 - "Community 139"
Cohesion: 0.11
Nodes (16): bool, DataFrame, datetime, COTSource, bool, DataFrame, datetime, YahooSource (+8 more)

### Community 140 - "Community 140"
Cohesion: 0.10
Nodes (23): iter_files, CacheHit, Cache.get, Cache.put, cmd_scan, cmd_scan_native, SQLite Manifest Persistence, RAGD Integration Contract (+15 more)

### Community 141 - "Community 141"
Cohesion: 0.13
Nodes (17): cmd_train(), main(), CLI for reservoir computing., Train ESN on features., evaluate_readout(), float, ndarray, Readout layer for ESN. (+9 more)

### Community 142 - "Community 142"
Cohesion: 0.16
Nodes (21): ChunkerFn, Chunk, chunker_for(), clear_registry(), list_registered(), str, Chunking hooks layer for dominion_loader.  Provides a hook registration mechanis, A document chunk as produced by a chunker strategy.      INTERFACE(agent-1): sta (+13 more)

### Community 143 - "Community 143"
Cohesion: 0.13
Nodes (21): _gpu_info(), hw_probe(), hw_probe_json(), int, str, _ram_bytes(), Hardware probe for dominion_loader.  Reports CPU count, RAM, GPU presence, and G, Return hardware profile for this machine.      Tolerates missing GPU gracefully (+13 more)

### Community 144 - "Community 144"
Cohesion: 0.10
Nodes (16): float, Timestamp, DataFrame, float, int, Timestamp, DataFrame, ExecutionStrategy (+8 more)

### Community 145 - "Community 145"
Cohesion: 0.15
Nodes (22): DataFrame, DatetimeIndex, int, compute_all_macro_features(), compute_breakeven_features(), compute_cpi_features(), compute_dxy_momentum(), compute_fed_features() (+14 more)

### Community 146 - "Community 146"
Cohesion: 0.16
Nodes (16): default_index_path(), int, Path, str, _safe(), _fetch_chunks(), Any, float (+8 more)

### Community 147 - "Community 147"
Cohesion: 0.11
Nodes (13): FTRLLogistic, alpha, beta, l1, l2, n, n_features, z (+5 more)

### Community 148 - "Community 148"
Cohesion: 0.12
Nodes (20): compute_slippage_bps(), float, str, Order matching engine with partial fills., Compute slippage in basis points.      Args:         fill_price: Actual fill pri, Walk the book to fill an order.      Args:         price: Limit price         si, walk_book(), Tests for execution simulator. (+12 more)

### Community 149 - "Community 149"
Cohesion: 0.19
Nodes (21): DataFrame, DatetimeIndex, compute_all_calendar_features(), compute_day_of_week(), compute_month_end(), compute_month_of_year(), compute_options_expiry(), compute_quarter() (+13 more)

### Community 150 - "Community 150"
Cohesion: 0.21
Nodes (13): commit_scan(), doctor_json(), exec(), initialize(), manifest_doctor_json(), manifest_init_json(), manifest_scan_json(), now_epoch() (+5 more)

### Community 151 - "Community 151"
Cohesion: 0.12
Nodes (13): bool, DataFrame, datetime, FREDSource, VoyageProvider, float, Any, float (+5 more)

### Community 152 - "Community 152"
Cohesion: 0.12
Nodes (19): fuse_ensemble_onnx(), Fuse ensemble into single ONNX graph., Create a fused ONNX graph combining base models + meta-learner.      For product, quantize_model(), INT4/INT8 dynamic quantisation of ONNX models., Apply dynamic quantisation, fall back to INT8 if INT4 degrades too much., Return max absolute difference between float and quantized model., _validate_quantization() (+11 more)

### Community 153 - "Community 153"
Cohesion: 0.11
Nodes (19): bool, float, resolve_conflict(), str, detect_anomaly(), Conflict resolution and anomaly detection for multi-source fusion., Resolve conflicts between sources.      Args:         observations: Dict mapping, Detect price anomaly via z-score.      Args:         price: Current price (+11 more)

### Community 154 - "Community 154"
Cohesion: 0.10
Nodes (20): IgnoreDecision, ignored, path, reason, rule_id, secret_protected, source, to_json (+12 more)

### Community 155 - "Community 155"
Cohesion: 0.10
Nodes (20): EMDResult, energies, frequencies, imfs, residual, SSAResult, components, explained_variance (+12 more)

### Community 156 - "Community 156"
Cohesion: 0.10
Nodes (20): drawdown_end, drawdown_start, ic, ic_pval, max_drawdown, mean_return, profit_factor, regime (+12 more)

### Community 157 - "Community 157"
Cohesion: 0.23
Nodes (20): cmd_features(), cmd_neural(), cmd_predictions(), cmd_telemetry_json(), cmd_trades(), find_latest_events(), find_latest_log(), load_latest_packet() (+12 more)

### Community 158 - "Community 158"
Cohesion: 0.22
Nodes (16): ExtractedDocument, clean_text(), html_to_text_fallback(), str, strip_noise(), extract(), _extract_with_bs4(), str (+8 more)

### Community 159 - "Community 159"
Cohesion: 0.12
Nodes (20): add_lag_features(), add_pairwise_ratios(), add_rolling_sweeps(), add_statistical_moments(), add_technical_indicators(), compute_lags_parallel(), compute_ratio_batch(), compute_rolling_parallel() (+12 more)

### Community 160 - "Community 160"
Cohesion: 0.19
Nodes (20): compute_baselines(), compute_cost_aware_metrics(), create_chronological_folds(), load_dataset(), main(), DataFrame, float, int (+12 more)

### Community 161 - "Community 161"
Cohesion: 0.10
Nodes (20): ModelMetadata, baseline_return_pct, created_at, direction_mode, horizon, model_edge_verdict, model_excess_return_pct, model_name (+12 more)

### Community 162 - "Community 162"
Cohesion: 0.10
Nodes (20): TradeIntent, confidence, config_name, direction, drawdown_risk_multiplier, entry_price, final_lot_size, kelly_fallback_used (+12 more)

### Community 163 - "Community 163"
Cohesion: 0.10
Nodes (19): columns, created, dataset, excluded_columns, n_features, n_labels, n_rows, raw_source (+11 more)

### Community 164 - "Community 164"
Cohesion: 0.15
Nodes (18): classify(), is_likely_binary(), bool, int, Path, str, File classification for dominion_loader.  Classifies each file into one of: code, Heuristic binary detection: check for null bytes in first sample_bytes.      Fas (+10 more)

### Community 165 - "Community 165"
Cohesion: 0.23
Nodes (19): cmd_report(), cmd_run(), load_market_data(), main(), DataFrame, float, Path, str (+11 more)

### Community 166 - "Community 166"
Cohesion: 0.13
Nodes (15): _fetch_hour(), _parse_bi5(), Fetch tick data day by day, build bars for requested timeframe., Parse bi5 binary tick data., Fetch one hour of tick data from Dukascopy CDN., Resample tick data to OHLCV bars., _ticks_to_bars(), bytes (+7 more)

### Community 167 - "Community 167"
Cohesion: 0.10
Nodes (19): cost_stress_results, dataset, decision_reason, final_verdict, finished_utc, git_sha, horizon_bars, label_column (+11 more)
...
Cohesion: 0.10
Nodes (19): candidates, cost_bps_list, dataset, dataset_dir, finished_utc, label_candidates_csv, max_rows, output_dir (+11 more)
...
Cohesion: 0.12
Nodes (15): bool, DataFrame, datetime, Exception, DomdataSource, MT5 data source via existing domdata CLI., MT5 tick and rate data via domdata CLI., Fetch XAU/USD data via domdata CLI. (+7 more)
...
Cohesion: 0.15
Nodes (19): add_target_variables(), compute_feature_stats(), compute_hash(), drop_nan_rows(), join_to_gold_master(), main(), pivot_features(), Add forward return targets. (+11 more)

### Community 180 - "Community 180"
Cohesion: 0.27
Nodes (18): add_targets(), build(), build_features(), build_micro_features(), build_return_features(), build_session_features(), build_trend_features(), build_volatility_features() (+10 more)

### Community 181 - "Community 181"
Cohesion: 0.11
Nodes (19): OOSResult, auc, bars_survived, config_name, ending_balance, max_drawdown_dollars, max_drawdown_pct, model_type (+11 more)

### Community 182 - "Community 182"
Cohesion: 0.16
Nodes (18): CompletedProcess, str, Tests for dominion doctor foundation checks., doctor --json must exit 1 when overall is fail (not silently exit 0)., doctor --json must always include overall field with meaningful value., doctor --strict --json must exit 1 when overall is warn., Without --strict, doctor exits 0 on warn (only fails on fail)., doctor --json overall must be the worst status across all checks. (+10 more)

### Community 183 - "Community 183"
Cohesion: 0.11
Nodes (18): DoctorCheck, details, message, name, remediation, severity, status, to_json (+10 more)

### Community 184 - "Community 184"
Cohesion: 0.17
Nodes (18): bool, DataFrame, DatetimeIndex, int, Series, compute_all_regime_features(), compute_historical_return_by_regime(), compute_regime_duration() (+10 more)

### Community 185 - "Community 185"
Cohesion: 0.14
Nodes (19): ndarray, fit_regime_hmm_model(), FittedRegimeHMM, _normalize_features(), _prepare_hmm_features(), Transform data using fitted HMM model (point-in-time safe, prefix-stable)., Fitted HMM regime model with frozen state mapping and normalization.      Attrib, Prepare HMM input features: returns, volatility, volume (raw, unnormalized). (+11 more)

### Community 186 - "Community 186"
Cohesion: 0.12
Nodes (18): fit_transform_split(), Fit HMM on training data, transform both train and OOS (point-in-time safe)., Tests for HMM regime leakage prevention.  ACCEPTANCE CRITERIA: 1. HMM fit on tra, fit_transform_split() should produce point-in-time safe features., Old detect_tactical_regime_hmm() should print deprecation warning., If hmmlearn not installed, fit_transform_split() should return 'unknown' regimes, compute_all_regime_features() should raise by default (fail-closed)., compute_all_regime_features(allow_leaky_hmm=True) should work but warn. (+10 more)

### Community 187 - "Community 187"
Cohesion: 0.18
Nodes (12): bool, ReportGenerator, Path, str, date, Daily intelligence report generator., Generate daily intelligence reports., Store report in DuckDB. (+4 more)

### Community 188 - "Community 188"
Cohesion: 0.11
Nodes (18): baseline_audit, direction_persistence, prev_target_corr, dataset, label_alignment, horizon, label_inspected, leak_feature (+10 more)

### Community 189 - "Community 189"
Cohesion: 0.29
Nodes (18): Index, candidate_paths(), git_output(), main(), normalize_columns(), ohlc_cols(), package_status(), pick_time_col() (+10 more)

### Community 190 - "Community 190"
Cohesion: 0.11
Nodes (18): AccountState, balance, equity, fail_reason, free_margin, is_failed, leverage, max_drawdown_dollars (+10 more)

### Community 191 - "Community 191"
Cohesion: 0.11
Nodes (18): ProbaDiagnostics, confidence_cap, constant_proba, count_flat, count_long, count_short, proba_max, proba_mean (+10 more)

### Community 192 - "Community 192"
Cohesion: 0.14
Nodes (11): csr_matrix, float, int, ndarray, Run ESN on sequence of inputs.          Args:             inputs: Input sequence, Initialize 3-scale ESN.          Args:             n_inputs: Number of input fea, Reset all reservoirs., Run all reservoirs and concatenate states.          Args:             inputs: In (+3 more)

### Community 193 - "Community 193"
Cohesion: 0.12
Nodes (6): compute_microstructure_features(), compute_price_impact_asymmetry(), compute_price_features(), cummax(), drawdown(), log_returns()

### Community 194 - "Community 194"
Cohesion: 0.18
Nodes (16): float, ndarray, bma_predict(), bma_weights(), Bayesian Model Averaging + threshold-based signal generation., Compute BMA weights from validation Sharpe ratios via softmax., Weighted average of model probabilities.      Args:         model_probs: (n_samp, Convert P(long) to signal and confidence.      Returns:         (signals, confid (+8 more)

### Community 195 - "Community 195"
Cohesion: 0.11
Nodes (17): Tests for LOB engine., Test LOB snapshot returns valid dict., Test LOB state machine updates., Test depth-weighted mid calculation., Test depth imbalance calculation., Test OFI computes correctly on known sequence., Test VPIN is bounded in [0,1]., Test Roll spread is non-negative. (+9 more)

### Community 196 - "Community 196"
Cohesion: 0.14
Nodes (12): bool, DataFrame, datetime, str, DataSource, fetch(), Abstract base class for data sources., Return health status of this source. (+4 more)

### Community 197 - "Community 197"
Cohesion: 0.31
Nodes (17): atr(), compute_alternative_features(), compute_cot_features(), compute_cross_asset_features(), compute_etf_features(), compute_htf_features(), compute_labels(), compute_macro_features() (+9 more)
...
Cohesion: 0.14
Nodes (17): add_lag_features(), add_pairwise_ratios(), add_rolling_sweeps(), add_technical_indicators(), compute_lags(), compute_ratios(), compute_rolling(), load_base_chunked() (+9 more)

### Community 200 - "Community 200"
Cohesion: 0.19
Nodes (15): Layout, build_command(), handle_event(), HydraState, main(), int, str, Render Rich dashboard layout. (+7 more)

### Community 201 - "Community 201"
Cohesion: 0.12
Nodes (17): Config, feature_score_method, ftrl_alpha, ftrl_beta, ftrl_l1, ftrl_l2, l2_lambda, learning_rate (+9 more)

### Community 202 - "Community 202"
Cohesion: 0.25
Nodes (16): DataFrame, int, Series, compute_all_crossasset_features(), compute_granger(), compute_lead_lag(), compute_partial_correlation(), compute_rolling_beta() (+8 more)

### Community 203 - "Community 203"
Cohesion: 0.22
Nodes (16): Any, int, str, ragd_deadzone_report(), ragd_handoff_read(), ragd_query(), ragd_remember(), ragd_todo_add() (+8 more)

### Community 204 - "Community 204"
Cohesion: 0.18
Nodes (10): generate_model_configs(), GPUMonitor, load_dataset(), log(), main(), Load dataset with maximum efficiency., Train single model with maximum GPU utilization., Live logging with timestamp and flush. (+2 more)

### Community 205 - "Community 205"
Cohesion: 0.23
Nodes (16): _count_active_locks(), _count_active_sessions(), _count_open_tasks(), _git_info(), _package_exists(), AgentStore, bool, int (+8 more)

### Community 206 - "Community 206"
Cohesion: 0.32
Nodes (16): _mode_icon(), _panel_complexity(), _panel_conflicts(), _panel_locks(), _panel_reviews(), _panel_sessions(), _panel_tasks(), AgentStore (+8 more)

### Community 207 - "Community 207"
Cohesion: 0.13
Nodes (16): baseline_metric_config, baseline_random_forest_model, baseline_ridge_model, data_quality_stats, dataset_v1, feature_categories, feature_stability_analysis, label_12b (+8 more)

### Community 208 - "Community 208"
Cohesion: 0.20
Nodes (10): connect(), disconnect(), iso8601_now(), publish(), publish_anomaly(), publish_dag_updated(), publish_pipeline_complete(), publish_regime_change() (+2 more)

### Community 209 - "Community 209"
Cohesion: 0.12
Nodes (16): LoadedSpecialistModel, baseline_return_pct, bias, direction_mode, min_confidence, model_edge_verdict, model_excess_return_pct, model_type (+8 more)

### Community 210 - "Community 210"
Cohesion: 0.12
Nodes (15): VaultDoctorReport, broken_links, examples, notes, ok, outside_repo_links, secret_reference_count, stale_links (+7 more)

### Community 211 - "Community 211"
Cohesion: 0.23
Nodes (15): DataFrame, int, compute_all_cot_features(), compute_cot_momentum(), compute_cot_percentiles(), compute_hedger_ratio(), compute_oi_features(), compute_spec_concentration() (+7 more)

### Community 212 - "Community 212"
Cohesion: 0.17
Nodes (15): DataFrame, DatetimeIndex, int, Series, compute_historical_return_by_regime(), compute_regime_duration(), compute_regime_transition(), detect_micro_regime() (+7 more)

### Community 213 - "Community 213"
Cohesion: 0.24
Nodes (13): has_drive_prefix(), lower(), normalize_path(), normalize_slashes(), path_has_parent_child_overlap(), safe_weakly_canonical(), slash_path(), starts_with_component_path() (+5 more)

### Community 214 - "Community 214"
Cohesion: 0.22
Nodes (15): analyze_dataset(), detect_time_column(), generate_markdown(), load_dataset(), main(), Path, str, Search reports/logs for overnight pipeline evidence. (+7 more)

### Community 215 - "Community 215"
Cohesion: 0.14
Nodes (14): compute_quote_features(), DataFrame, Quote dynamics features (10)., Compute 10 quote dynamics features.      Args:         df: DataFrame with quote, compute_all_features(), DataFrame, int, Path (+6 more)

### Community 216 - "Community 216"
Cohesion: 0.13
Nodes (15): BrokerEquityRow, account_failed, balance, bar_index, close_price, config, drawdown_dollars, drawdown_pct (+7 more)

### Community 217 - "Community 217"
Cohesion: 0.19
Nodes (14): float, optimal_trajectory(), permanent_impact(), Almgren-Chriss (2001) market impact model., Compute temporary impact per slice (bps).      Args:         rate: Trade rate (q, Compute total execution cost for a trajectory.      Args:         trajectory: Li, Compute optimal trajectory using Almgren-Chriss closed form.      Args:, Compute permanent impact (bps).      Args:         quantity: Trade size (+6 more)

### Community 218 - "Community 218"
Cohesion: 0.21
Nodes (14): export_catboost_to_onnx(), export_lgbm_to_onnx(), export_pytorch_to_onnx(), export_sklearn_to_onnx(), export_xgb_to_onnx(), Export models to ONNX format., Export sklearn model to ONNX via skl2onnx., Export LightGBM to ONNX via onnxmltools. (+6 more)

### Community 219 - "Community 219"
Cohesion: 0.31
Nodes (12): compute_features(), fetch_sources(), fuse_prices(), generate_report(), generate_uuid(), health_checks(), log_error(), notify() (+4 more)

### Community 220 - "Community 220"
Cohesion: 0.21
Nodes (14): compute_roll_spread(), generate_synthetic_quotes(), load_gold_ticks(), prepare_lob_data(), DataFrame, float, int, Path (+6 more)

### Community 221 - "Community 221"
Cohesion: 0.25
Nodes (14): compute_all_metrics(), compute_corwin_schultz_spread(), compute_ofi(), compute_roll_spread(), compute_vpin(), DataFrame, int, Series (+6 more)

### Community 222 - "Community 222"
Cohesion: 0.22
Nodes (11): OllamaProvider, Any, str, test_ollama_api_key_ignored(), test_ollama_embed_batch_multiple_texts(), test_ollama_embed_batch_single_text(), test_ollama_health_connection_error(), test_ollama_health_model_not_found() (+3 more)

### Community 223 - "Community 223"
Cohesion: 0.13
Nodes (14): created, dataset, decay_statistics, max, mean, median, min, std (+6 more)

### Community 224 - "Community 224"
Cohesion: 0.18
Nodes (13): cmd_compute(), cmd_metrics(), cmd_vpin(), main(), int, Main CLI entry point., Compute LOB metrics and store to DuckDB., Show latest LOB metrics.      Args:         top_k: Number of recent rows to show (+5 more)

### Community 225 - "Community 225"
Cohesion: 0.23
Nodes (14): float, int, ndarray, cot_filter(), _perm_entropy(), permutation_entropy_gate(), Tradeability filters: permutation entropy, COT, toxicity, spread., Returns boolean mask: True where trading is allowed. (+6 more)

### Community 226 - "Community 226"
Cohesion: 0.19
Nodes (14): cmd_compute(), cmd_decay(), cmd_top(), load_lob_data(), main(), DataFrame, float, int (+6 more)

### Community 227 - "Community 227"
Cohesion: 0.14
Nodes (13): NormalizedPath, absolute, display, error, exists, is_symlink, realpath, relative (+5 more)

### Community 228 - "Community 228"
Cohesion: 0.15
Nodes (7): compute_cot_features(), compute_crossasset_features(), compute_macro_features(), compute_roll_spread(), diff(), pct_change(), compute_fractional_diff_features()

### Community 229 - "Community 229"
Cohesion: 0.16
Nodes (9): bool, float, ndarray, HydraAdversary, HYDRA-ADVERSARY: predicts whether next trade will lose., LightGBM classifier trained on past trade outcomes to veto bad entries., Train on historical trade features. outcomes: 1=loss, 0=win., Returns True if trade should be vetoed. (+1 more)

### Community 230 - "Community 230"
Cohesion: 0.14
Nodes (13): alternative, composite, cross_asset, cross_timeframe, entropy_fractal, interactions, macro, microstructure (+5 more)

### Community 231 - "Community 231"
Cohesion: 0.22
Nodes (13): check_feature_decay(), compute_forward_returns(), compute_ic(), DataFrame, int, Path, Series, IC tracking and decay monitoring. (+5 more)

### Community 232 - "Community 232"
Cohesion: 0.21
Nodes (8): float, int, ndarray, Train GAT to reconstruct target.          Simple supervised training: minimize M, Initialize GAT.          Args:             n_features: Number of input features, Xavier initialization., Compute attention score between two nodes.          Args:             h_i: Embed, Forward pass.          Args:             features: Node features (n_nodes, n_fea

### Community 233 - "Community 233"
Cohesion: 0.17
Nodes (11): MultiScaleESN, Echo State Network implementation., 3-reservoir ESN stack for multi-timescale dynamics., Test ESN state updates correctly., Test spectral radius property., Test washout removes transient., Test multi-scale ESN., test_esn_spectral_radius() (+3 more)

### Community 234 - "Community 234"
Cohesion: 0.18
Nodes (13): Hybrid Retrieval (BM25 + Vector), Reciprocal Rank Fusion (RRF), _matches_filters, _rrf, _matches_filters(), bool, float, int (+5 more)

### Community 235 - "Community 235"
Cohesion: 0.19
Nodes (7): compute_complexity_entropy_plane(), compute_conditional_entropy(), compute_lz_complexity(), compute_permutation_entropy(), ordinal_pattern(), pattern_to_id(), compute_approximate_entropy()

### Community 236 - "Community 236"
Cohesion: 0.15
Nodes (12): cmd_backfill(), cmd_doctor(), cmd_features(), cmd_report(), cmd_run(), cmd_status(), main(), CLI interface for data pipeline. (+4 more)

### Community 237 - "Community 237"
Cohesion: 0.15
Nodes (12): best_baseline_name, best_baseline_return_net, created_utc, dataset_info, feature_candidates, label_positive_rate, rows, disclaimer (+4 more)
...
Cohesion: 0.38
Nodes (12): collect(), dir_size(), last_json(), latest_file(), main(), print_text(), Any, int (+4 more)

### Community 414 - "Community 414"
Cohesion: 0.27
Nodes (12): inject_synced_timestamp(), main(), parse_frontmatter(), bool, Path, str, Parse YAML frontmatter from markdown content., Add or update 'synced' timestamp in frontmatter. (+4 more)

### Community 415 - "Community 415"
Cohesion: 0.17
Nodes (11): compute_flow_features(), DataFrame, Order flow features (10)., Compute 10 order flow features.      Args:         df: DataFrame with price/volu, Tests for execution features., Test flow features returns 10 columns., Test IC is in [-1, 1]., Test forward returns computes correctly. (+3 more)

### Community 416 - "Community 416"
Cohesion: 0.29
Nodes (12): bool, str, Input validators for Dominion Agent OS.  Validates enums, transitions, and field, Return True if transitioning from current to target is allowed., Raise ValueError if value is empty or whitespace., require_nonempty(), validate_lock_mode(), validate_role() (+4 more)

### Community 417 - "Community 417"
Cohesion: 0.15
Nodes (13): _check_active_manifest_without_chunks, _check_cache_integrity, _check_deleted_chunk_leaks, _check_domdata_guard, _check_duplicate_active_chunks, _check_ignore_policy_alignment, _check_manifest_readable, _check_orphan_active_chunks (+5 more)

### Community 418 - "Community 418"
Cohesion: 0.17
Nodes (11): enabledPlugins, claude-md-management@claude-plugins-official, code-review@claude-plugins-official, context7@claude-plugins-official, feature-dev@claude-plugins-official, github@claude-plugins-official, skill-creator@claude-plugins-official, superpowers@claude-plugins-official (+3 more)

### Community 419 - "Community 419"
Cohesion: 0.26
Nodes (11): bool, int, str, emit_event(), _get_client(), RAGD daemon client for episodic memory., Ingest a memory into RAGD., Retrieve k nearest memories from RAGD. (+3 more)

### Community 420 - "Community 420"
Cohesion: 0.17
Nodes (11): determinism, hash1, hash2, passed, dropped_columns, feature_count, feature_gate_passed, first_timestamp (+3 more)

### Community 421 - "Community 421"
Cohesion: 0.17
Nodes (11): AgentLock, expires_at, mode, path, session_id, status, LockDecision, acquired (+3 more)

### Community 422 - "Community 422"
Cohesion: 0.17
Nodes (11): FileClassification, binary, encoding, generated, kind, language, large, path (+3 more)

### Community 423 - "Community 423"
Cohesion: 0.17
Nodes (11): HestonParams, kappa, rho, sigma, theta, v0, SABRParams, alpha (+3 more)

### Community 424 - "Community 424"
Cohesion: 0.17
Nodes (12): FusedBar, anomaly_flag, close, fused_confidence, fused_price, high, low, open (+4 more)

### Community 425 - "Community 425"
Cohesion: 0.26
Nodes (11): float, ndarray, compute_all_metrics(), compute_cost_adjusted_metrics(), compute_training_metrics(), print_metrics_report(), Training metrics - extend hydra/backtest/metrics.py with ML-specific metrics., Compute all metrics (ML + backtest + cost-aware).      Args:         y_true: Tru (+3 more)

### Community 426 - "Community 426"
Cohesion: 0.30
Nodes (8): chunk_id(), document_id(), hex_digest(), sha256_bytes(), sha256_file(), sha256_string(), Sha256Ctx, ctx_

### Community 427 - "Community 427"
Cohesion: 0.29
Nodes (10): contains(), decide(), default_ignore_policy(), fingerprint(), load_ignore_policy(), lower(), path_parts(), policy_json() (+2 more)

### Community 428 - "Community 428"
Cohesion: 0.17
Nodes (12): config, cost_bps, dataset, embargo_bars, folds, horizon_bars, label_column, max_rows (+4 more)
...
Cohesion: 0.21
Nodes (8): bool, DataFrame, datetime, AlphaVantageSource, Alpha Vantage data source., Validate Alpha Vantage data., Alpha Vantage gold price source., Fetch gold OHLCV from Alpha Vantage with aggressive caching.

### Community 566 - "Community 566"
Cohesion: 0.17
Nodes (11): bundle, details, elapsed_ms, metrics, citation_accuracy, mrr, ndcg@10, recall@10 (+3 more)
...
Cohesion: 0.17
Nodes (11): dataset, label_balance, label_column, n_features, n_rows, timestamp, train_test_split, test (+3 more)

### Community 608 - "Community 608"
Cohesion: 0.41
Nodes (11): apply_env(), defaults(), expand_list(), expand_user(), from_args(), from_file(), home(), set_if_json() (+3 more)

### Community 609 - "Community 609"
Cohesion: 0.18
Nodes (11): baseline_results, dataset, model, note, test_directional_accuracy, test_max_drawdown_pct, test_r2, test_sharpe (+3 more)

### Community 610 - "Community 610"
Cohesion: 0.18
Nodes (11): EquityCurveRow, bar_index, commission, config, drawdown_dollars, drawdown_pct, equity, gross_pnl (+3 more)

### Community 611 - "Community 611"
Cohesion: 0.18
Nodes (7): LogisticRegression, bias, l2_lambda, learning_rate, n_epochs, training_failed, weights

### Community 612 - "Community 612"
Cohesion: 0.18
Nodes (10): computedHash, skillPath, source, sourceType, source, sourceType, skills, bioservices (+2 more)

### Community 613 - "Community 613"
Cohesion: 0.18
Nodes (11): Bar, close, high, low, open, quality_score, source, spread (+3 more)

### Community 615 - "Community 615"
Cohesion: 0.27
Nodes (10): bool, DataFrame, str, asof_join_backward(), multi_asof_join(), Point-in-time safe join engine. Ensures no future data leakage when merging mult, Point-in-time safe asof join (backward).      For each left row at time t, joins, Join multiple data sources with point-in-time safety.      Args:         base: B (+2 more)

### Community 616 - "Community 616"
Cohesion: 0.18
Nodes (10): B_0013, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 617 - "Community 617"
Cohesion: 0.22
Nodes (11): label_columns_found, no_constant_features, no_infinite_values, count, examples, details, passed, details (+3 more)

### Community 618 - "Community 618"
Cohesion: 0.27
Nodes (10): format_eta(), get_log_tail(), get_process_info(), get_real_progress(), monitor(), parse_runtime(), Parse runtime string to seconds., Get ACTUAL progress from CSV file (no estimates). (+2 more)

### Community 619 - "Community 619"
Cohesion: 0.20
Nodes (9): artifact_type, current_command, is_fallback, is_final, output_file, pid, status, task_id (+1 more)

### Community 620 - "Community 620"
Cohesion: 0.24
Nodes (6): RankEnsemble, feature_indices, feature_signs, feature_weights, sigmoid_a, sigmoid_b

### Community 621 - "Community 621"
Cohesion: 0.31
Nodes (9): check_m5_duckdb(), check_m5_parquet(), M5Status, M5 data requirements for HYDRA dataset. Checks if M5 source exists, otherwise bl, Check for M5 data. If missing, return blocker status.     Training must not proc, M5 data availability status., Check for M5 parquet file., Check for M5 data in DuckDB. (+1 more)

### Community 622 - "Community 622"
Cohesion: 0.20
Nodes (9): ScopeOverlap, overlap, reasons, risk, to_json, TaskScope, packages, paths (+1 more)

### Community 623 - "Community 623"
Cohesion: 0.20
Nodes (9): BettiNumbers, betti_0, betti_1, betti_2, PersistenceResult, birth_times, death_times, dimensions (+1 more)

### Community 624 - "Community 624"
Cohesion: 0.20
Nodes (10): Tick, ask, bid, collected_at, flags, mid, spread, time_msc (+2 more)

### Community 625 - "Community 625"
Cohesion: 0.24
Nodes (6): compute_causal_dag_strengths(), compute_transfer_entropy(), rolling_correlation(), compute_mutual_information(), compute_transfer_entropy(), discretize()

### Community 626 - "Community 626"
Cohesion: 0.20
Nodes (10): momentum, avg_trade_return, flat_rate, long_count, max_drawdown, short_count, total_return_gross, total_return_net (+2 more)

### Community 627 - "Community 627"
Cohesion: 0.20
Nodes (10): baselines, random_seed_1, avg_trade_return, long_count, max_drawdown, short_count, total_return_gross, total_return_net (+2 more)
...
Cohesion: 0.20
Nodes (10): baselines, random_seed_4, avg_trade_return, long_count, max_drawdown, short_count, total_return_gross, total_return_net (+2 more)
...
Cohesion: 0.31
Nodes (10): ragd_graph_build_graph_fn, ragd_graph_callees_fn, ragd_graph_callers_fn, ragd_graph_cli, ragd_graph_graph_stats_class, ragd_graph_importers_fn, ragd_graph_imports_fn, ragd_graph_kg_edges_table (+2 more)

### Community 901 - "Community 901"
Cohesion: 0.20
Nodes (10): B_0000, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 902 - "Community 902"
Cohesion: 0.20
Nodes (10): B_0001, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 903 - "Community 903"
Cohesion: 0.20
Nodes (10): B_0002, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 904 - "Community 904"
Cohesion: 0.20
Nodes (10): B_0003, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 905 - "Community 905"
Cohesion: 0.20
Nodes (10): B_0004, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 906 - "Community 906"
Cohesion: 0.20
Nodes (10): B_0005, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 907 - "Community 907"
Cohesion: 0.20
Nodes (10): B_0006, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 908 - "Community 908"
Cohesion: 0.20
Nodes (10): B_0007, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 909 - "Community 909"
Cohesion: 0.20
Nodes (10): B_0008, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 910 - "Community 910"
Cohesion: 0.20
Nodes (10): B_0009, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 911 - "Community 911"
Cohesion: 0.20
Nodes (10): B_0010, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 912 - "Community 912"
Cohesion: 0.20
Nodes (10): B_0011, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 913 - "Community 913"
Cohesion: 0.20
Nodes (10): B_0012, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 914 - "Community 914"
Cohesion: 0.20
Nodes (10): B_0014, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 915 - "Community 915"
Cohesion: 0.20
Nodes (10): B_0015, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 916 - "Community 916"
Cohesion: 0.20
Nodes (10): B_0016, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 917 - "Community 917"
Cohesion: 0.20
Nodes (10): B_0017, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 918 - "Community 918"
Cohesion: 0.20
Nodes (10): B_0018, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 919 - "Community 919"
Cohesion: 0.20
Nodes (10): B_0019, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 920 - "Community 920"
Cohesion: 0.20
Nodes (10): B_0020, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 921 - "Community 921"
Cohesion: 0.20
Nodes (10): B_0021, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 922 - "Community 922"
Cohesion: 0.20
Nodes (10): B_0022, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 923 - "Community 923"
Cohesion: 0.20
Nodes (10): B_0023, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 924 - "Community 924"
Cohesion: 0.20
Nodes (10): B_0024, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 925 - "Community 925"
Cohesion: 0.20
Nodes (10): B_0025, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 926 - "Community 926"
Cohesion: 0.20
Nodes (10): B_0026, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 927 - "Community 927"
Cohesion: 0.20
Nodes (10): B_0027, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 928 - "Community 928"
Cohesion: 0.20
Nodes (10): B_0028, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 929 - "Community 929"
Cohesion: 0.20
Nodes (10): B_0029, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 930 - "Community 930"
Cohesion: 0.20
Nodes (10): B_0030, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 931 - "Community 931"
Cohesion: 0.20
Nodes (10): B_0031, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 932 - "Community 932"
Cohesion: 0.20
Nodes (10): B_0032, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 933 - "Community 933"
Cohesion: 0.20
Nodes (10): B_0033, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 934 - "Community 934"
Cohesion: 0.20
Nodes (10): B_0034, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 935 - "Community 935"
Cohesion: 0.20
Nodes (10): B_0035, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 936 - "Community 936"
Cohesion: 0.20
Nodes (10): B_0036, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 937 - "Community 937"
Cohesion: 0.20
Nodes (10): B_0037, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 938 - "Community 938"
Cohesion: 0.20
Nodes (10): B_0038, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 939 - "Community 939"
Cohesion: 0.20
Nodes (10): B_0039, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 940 - "Community 940"
Cohesion: 0.20
Nodes (10): B_0040, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 941 - "Community 941"
Cohesion: 0.20
Nodes (10): B_0041, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 942 - "Community 942"
Cohesion: 0.20
Nodes (10): B_0042, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 943 - "Community 943"
Cohesion: 0.20
Nodes (10): B_0043, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 944 - "Community 944"
Cohesion: 0.20
Nodes (10): B_0044, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 945 - "Community 945"
Cohesion: 0.20
Nodes (10): B_0045, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 946 - "Community 946"
Cohesion: 0.20
Nodes (10): B_0046, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 947 - "Community 947"
Cohesion: 0.20
Nodes (10): B_0047, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 948 - "Community 948"
Cohesion: 0.20
Nodes (10): B_0048, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)

### Community 949 - "Community 949"
Cohesion: 0.20
Nodes (10): B_0049, block_id, computation_function, is_trainable_feature, notes, original_placeholder_name, point_in_time_rule, registry_slot (+2 more)
...
Cohesion: 0.31
Nodes (9): fetch_all_m5(), fetch_m5_batch(), main(), DataFrame, int, Fetch one batch of M5 bars via domdata., Fetch all available M5 bars., Validate M5 data quality. (+1 more)

### Community 1029 - "Community 1029"
Cohesion: 0.29
Nodes (6): route_intent(), enrich(), parse_array(), query_json(), relative_path_for(), result_to_json()

### Community 1030 - "Community 1030"
Cohesion: 0.24
Nodes (9): generate_alerts(), DataFrame, Path, Toxicity alerting logic., Generate toxicity alerts based on thresholds.      Args:         metrics: DataFr, Store alerts to DuckDB and anomaly_log.      Args:         alerts: List of alert, store_alerts(), cmd_compute() (+1 more)

### Community 1031 - "Community 1031"
Cohesion: 0.22
Nodes (9): limitations, calendar, determinism, features, format, leakage_proof, manifest, quantlib (+1 more)

### Community 1032 - "Community 1032"
Cohesion: 0.22
Nodes (8): policy, dir_deny, ext_deny, policy_hash, max_bytes, path_deny, secrets_always_ignored, version

### Community 1033 - "Community 1033"
Cohesion: 0.31
Nodes (8): get_timestamp(), DatasetRow, features, time, load_csv(), main(), reconstruct_price(), write_csv()

### Community 1034 - "Community 1034"
Cohesion: 0.39
Nodes (6): check_staleness(), detect_gaps(), fill_small_gaps(), get_health_summary(), monitor_gold_dxy_correlation(), parse_iso()

### Community 1035 - "Community 1035"
Cohesion: 0.22
Nodes (9): dominion_loader_cmd_scan_native, dominion_loader_delete_result_class, dominion_loader_ingest_result_class, dominion_loader_native_scan_binary, dominion_loader_ragd_bridge_class, dominion_loader_scan_fn, dominion_loader_scan_stats_class, dominion_loader_tests_ragd_bridge (+1 more)

### Community 1036 - "Community 1036"
Cohesion: 0.22
Nodes (7): ManifestStore, commit_scan, db_, doctor_json, exec, initialize, open

### Community 1037 - "Community 1037"
Cohesion: 0.22
Nodes (9): COTData, commercial_long, commercial_short, net_commercial, noncommercial_long, noncommercial_short, open_interest, report_date (+1 more)

### Community 1038 - "Community 1038"
Cohesion: 0.22
Nodes (7): DataFrame, float, Timestamp, generate_slices(), Base execution strategy., Initialize strategy.          Args:             target_quantity: Total quantity, remaining_quantity()

### Community 1039 - "Community 1039"
Cohesion: 0.42
Nodes (7): command_ok(), home_dir(), make_check(), run_capture(), run_native_doctor(), tcp_connects(), to_json()

### Community 1040 - "Community 1040"
Cohesion: 0.22
Nodes (9): avg_trade_return, long_count, max_drawdown, short_count, total_return_gross, total_return_net, trade_count, win_rate (+1 more)
...
Cohesion: 0.22
Nodes (9): random_seed_0, avg_trade_return, long_count, max_drawdown, short_count, total_return_gross, total_return_net, trade_count (+1 more)

### Community 1043 - "Community 1043"
Cohesion: 0.22
Nodes (9): random_seed_2, avg_trade_return, long_count, max_drawdown, short_count, total_return_gross, total_return_net, trade_count (+1 more)

### Community 1044 - "Community 1044"
Cohesion: 0.22
Nodes (9): random_seed_3, avg_trade_return, long_count, max_drawdown, short_count, total_return_gross, total_return_net, trade_count (+1 more)

### Community 1045 - "Community 1045"
Cohesion: 0.22
Nodes (9): random_seed_4, avg_trade_return, long_count, max_drawdown, short_count, total_return_gross, total_return_net, trade_count (+1 more)

### Community 1046 - "Community 1046"
Cohesion: 0.22
Nodes (9): random_seed_5, avg_trade_return, long_count, max_drawdown, short_count, total_return_gross, total_return_net, trade_count (+1 more)

### Community 1047 - "Community 1047"
Cohesion: 0.22
Nodes (9): random_seed_6, avg_trade_return, long_count, max_drawdown, short_count, total_return_gross, total_return_net, trade_count (+1 more)

### Community 1048 - "Community 1048"
Cohesion: 0.22
Nodes (9): random_seed_7, avg_trade_return, long_count, max_drawdown, short_count, total_return_gross, total_return_net, trade_count (+1 more)

### Community 1049 - "Community 1049"
Cohesion: 0.22
Nodes (9): random_seed_8, avg_trade_return, long_count, max_drawdown, short_count, total_return_gross, total_return_net, trade_count (+1 more)

### Community 1050 - "Community 1050"
Cohesion: 0.22
Nodes (9): random_seed_9, avg_trade_return, long_count, max_drawdown, short_count, total_return_gross, total_return_net, trade_count (+1 more)

### Community 1051 - "Community 1051"
Cohesion: 0.22
Nodes (9): model_results, avg_trade_return, long_count, max_drawdown, short_count, total_return_gross, total_return_net, trade_count (+1 more)
...
Cohesion: 0.22
Nodes (9): random_seed_1, avg_trade_return, long_count, max_drawdown, short_count, total_return_gross, total_return_net, trade_count (+1 more)
...
Cohesion: 0.33
Nodes (6): BatchStats, EmbedProvider, float, int, str, Embed batch, splitting in half on 400 errors.
...
Cohesion: 0.33
Nodes (8): compile_dir(), compile_scripts(), main(), bool, int, Path, Compile one directory tree, skipping excluded subdirs. Returns True on success., Compile only *.py files directly in scripts/ (no sub-crawl into bin/).

### Community 3154 - "Community 3154"
Cohesion: 0.31
Nodes (8): compute_split_dates(), list_available_features(), main(), List all feature columns in gold_master., Validate split meets requirements., Compute and validate temporal split., Compute train/val/test split boundaries., validate_split()

### Community 3155 - "Community 3155"
Cohesion: 0.25
Nodes (7): Tests for toxicity monitor., Test OFI has correct sign for buy pressure., test_ofi_sign(), compute_ofi_features(), DataFrame, Order Flow Imbalance (OFI) calculations., Compute OFI at multiple time windows.      Args:         df: DataFrame with 'tim

### Community 3156 - "Community 3156"
Cohesion: 0.25
Nodes (8): FeatureScore, composite, feature_idx, mutual_info, pearson_ic, spearman_ic, stability, turnover

### Community 3157 - "Community 3157"
Cohesion: 0.25
Nodes (8): KellyEstimate, avg_loss, avg_win, kelly_raw, payoff_ratio, sample_count, valid, win_rate

### Community 3158 - "Community 3158"
Cohesion: 0.25
Nodes (7): CausalGraph, edges, nodes, GrangerResult, causality_strength, f_statistic, p_value

### Community 3159 - "Community 3159"
Cohesion: 0.25
Nodes (7): MFDFAResult, alpha, f_alpha, hurst_q, multifractal_width, q_orders, tau_q

### Community 3160 - "Community 3160"
Cohesion: 0.25
Nodes (8): PipelineRun, completed_at, errors, features_computed, run_id, sources_fetched, started_at, status

### Community 3161 - "Community 3161"
Cohesion: 0.25
Nodes (5): BarData, close, high, low, volume

### Community 3162 - "Community 3162"
Cohesion: 0.25
Nodes (7): BacktestConfig, CVConfig, EnsembleConfig, FeatureConfig, HYDRA global configuration — all hyperparameters, paths, constants., StopConfig, TargetConfig

### Community 3163 - "Community 3163"
Cohesion: 0.25
Nodes (8): failure_analysis, baseline_dominated, cost_stress_failed, missing_summary, net_negative, script_error, too_few_trades, too_much_drawdown
...
Cohesion: 0.39
Nodes (6): analyze_scope_overlap(), any_file_contains(), any_file_ext(), has_command(), intersects(), validate_completion_evidence()

### Community 3169 - "Community 3169"
Cohesion: 0.46
Nodes (6): add_example(), extract_links(), inspect_vault_native(), is_url_or_anchor(), starts_with(), strip_fragment()

### Community 3170 - "Community 3170"
Cohesion: 0.29
Nodes (5): Protocol, EmbedProvider, Any, float, str

### Community 3171 - "Community 3171"
Cohesion: 0.32
Nodes (4): OpenAIProvider, Any, float, str

### Community 3172 - "Community 3172"
Cohesion: 0.29
Nodes (4): float, str, FlakyProvider, test_batches_split_and_retry()

### Community 3173 - "Community 3173"
Cohesion: 0.25
Nodes (7): elapsed_seconds, n_configs, n_folds, n_results, openmp_enabled, threads, timestamp
...
Cohesion: 0.25
Nodes (8): baselines, mean_reversion, auc, avg_pnl_per_bar, balanced_accuracy, max_drawdown, net_return, sharpe

### Community 3179 - "Community 3179"
Cohesion: 0.25
Nodes (8): auc, avg_pnl_per_bar, balanced_accuracy, max_drawdown, net_return, sharpe, models, all

### Community 3180 - "Community 3180"
Cohesion: 0.36
Nodes (7): convert_to_parquet(), fetch_timeframe(), main(), str, Download XAU/USD history from MT5 via Wine Python bridge.  This script calls Win, Convert downloaded JSON to parquet., Fetch one timeframe via Wine Python subprocess.

### Community 3181 - "Community 3181"
Cohesion: 0.50
Nodes (7): generate_visualization(), load_dataset(), log(), main(), Generate comparison plots., Load and prepare dataset., train_model()

### Community 3182 - "Community 3182"
Cohesion: 0.25
Nodes (7): Tests for health monitoring., Test price anomaly detection., Test volume anomaly detection., Test source divergence detection., test_anomaly_detector_price(), test_anomaly_detector_volume(), test_source_divergence_detection()

### Community 3183 - "Community 3183"
Cohesion: 0.25
Nodes (7): Test adverse selection = effective - realized., test_adverse_selection_formula(), compute_adverse_selection(), DataFrame, int, Adverse selection metrics., Compute adverse selection metrics.      Args:         df: DataFrame with 'timest

### Community 3184 - "Community 3184"
Cohesion: 0.36
Nodes (7): cmd_alerts(), cmd_status(), main(), int, Toxicity monitor CLI., Show recent alerts.      Args:         since_days: Days to look back, Show current toxicity status.

### Community 3185 - "Community 3185"
Cohesion: 0.25
Nodes (7): Test VPIN is in [0,1]., test_vpin_bounded(), compute_vpin_detailed(), DataFrame, int, VPIN calculation (Volume-Synchronized PIN)., Compute VPIN using bulk volume classification.      Args:         df: DataFrame

### Community 3186 - "Community 3186"
Cohesion: 0.29
Nodes (6): mcpServers, ragd, description, name, type, url

### Community 3187 - "Community 3187"
Cohesion: 0.29
Nodes (7): Meta, cols, commission_per_lot, gold_oz_per_lot, horizon, label, rows

### Community 3188 - "Community 3188"
Cohesion: 0.29
Nodes (7): PnLResult, commission, gross_pnl, max_drawdown, n_position_changes, net_pnl, sharpe

### Community 3189 - "Community 3189"
Cohesion: 0.33
Nodes (7): defect_d01_deletion_propagation, defect_d02_query_metadata, defect_d09_orphan_chunks, live_green_plan, phase_3_truth_final, ragd_health_issue, vault_broken_links

### Community 3190 - "Community 3190"
Cohesion: 0.33
Nodes (4): Citation, Any, str, text()

### Community 3191 - "Community 3191"
Cohesion: 0.52
Nodes (6): cmd_doctor(), cmd_features(), cmd_run(), cmd_status(), main(), print_usage()

### Community 3192 - "Community 3192"
Cohesion: 0.29
Nodes (7): Anomaly, description, severity, source, timestamp, type, value

### Community 3193 - "Community 3193"
Cohesion: 0.29
Nodes (7): RegimeLabel, confidence, macro_regime, micro_regime, structural_regime, tactical_regime, timestamp

### Community 3194 - "Community 3194"
Cohesion: 0.29
Nodes (7): SourceHealth, error_count, last_fetch, latency_ms, source, status, trust_score

### Community 3195 - "Community 3195"
Cohesion: 0.48
Nodes (6): KalmanFilter(), KalmanFilterBank(), fuse(), predict(), update(), update_trust()

### Community 3196 - "Community 3196"
Cohesion: 0.38
Nodes (4): ndarray, Generate OOF predictions and train meta-learner., Average each base model's fold predictions, then meta-learner., Return raw base model predictions (n_samples, n_models).

### Community 3197 - "Community 3197"
Cohesion: 0.38
Nodes (3): compute_hansen_lunde_rv(), compute_microstructure_snr(), compute_noise_variance()

### Community 3198 - "Community 3198"
Cohesion: 0.29
Nodes (7): details, passed, checks, acceptable_null_rate, overall_null_pct, worst_feature, worst_null_pct

### Community 3199 - "Community 3199"
Cohesion: 0.29
Nodes (7): auc, avg_pnl_per_bar, balanced_accuracy, max_drawdown, net_return, sharpe, always_long

### Community 3200 - "Community 3200"
Cohesion: 0.29
Nodes (7): auc, avg_pnl_per_bar, balanced_accuracy, max_drawdown, net_return, sharpe, always_short

### Community 3201 - "Community 3201"
Cohesion: 0.29
Nodes (7): momentum_20, auc, avg_pnl_per_bar, balanced_accuracy, max_drawdown, net_return, sharpe

### Community 3202 - "Community 3202"
Cohesion: 0.29
Nodes (7): previous_bar, auc, avg_pnl_per_bar, balanced_accuracy, max_drawdown, net_return, sharpe

### Community 3203 - "Community 3203"
Cohesion: 0.29
Nodes (7): top_100, auc, avg_pnl_per_bar, balanced_accuracy, max_drawdown, net_return, sharpe

### Community 3204 - "Community 3204"
Cohesion: 0.29
Nodes (7): top_200, auc, avg_pnl_per_bar, balanced_accuracy, max_drawdown, net_return, sharpe

### Community 3205 - "Community 3205"
Cohesion: 0.38
Nodes (6): compute_rolling_ic(), detect_ic_decay(), main(), Compute rolling IC (Spearman correlation).      Args:         feature_values: Fe, Detect if IC has decayed significantly.      Args:         rolling_ics: List of, Analyze feature stability.

### Community 3206 - "Community 3206"
Cohesion: 0.29
Nodes (6): compute_depth_features(), DataFrame, Depth/book features (10)., Compute 10 depth features.      Args:         df: DataFrame with 'bid', 'ask', ', Test depth features returns 10 columns., test_depth_features_count()

### Community 3207 - "Community 3207"
Cohesion: 0.29
Nodes (6): compute_spread_features(), DataFrame, Spread dynamics features (10)., Compute 10 spread features.      Args:         df: DataFrame with 'bid', 'ask',, Test spread features returns 10 columns., test_spread_features_count()

### Community 3208 - "Community 3208"
Cohesion: 0.33
Nodes (6): hard_rules, manual_commands_only, no_final_claim, no_performance_claim, no_training, validation_only

### Community 3209 - "Community 3209"
Cohesion: 0.33
Nodes (6): BaselineResult, max_drawdown_pct, name, profit_factor, return_pct, total_trades

### Community 3210 - "Community 3210"
Cohesion: 0.33
Nodes (4): FeatureNormalizer, means, n_features, stds

### Community 3211 - "Community 3211"
Cohesion: 0.33
Nodes (6): Stump, feature_idx, left_class, right_class, threshold, weight

### Community 3212 - "Community 3212"
Cohesion: 0.33
Nodes (6): cot, columns, path, role, rows, status

### Community 3213 - "Community 3213"
Cohesion: 0.33
Nodes (6): cross_asset_daily, columns, path, role, rows, status

### Community 3214 - "Community 3214"
Cohesion: 0.33
Nodes (6): etf_flows, columns, path, role, rows, status

### Community 3215 - "Community 3215"
Cohesion: 0.33
Nodes (6): gpr, columns, path, role, rows, status

### Community 3216 - "Community 3216"
Cohesion: 0.33
Nodes (6): master_clean, columns, path, role, rows, status

### Community 3217 - "Community 3217"
Cohesion: 0.33
Nodes (6): mt5_d1, columns, path, role, rows, status

### Community 3218 - "Community 3218"
Cohesion: 0.33
Nodes (6): mt5_h1, columns, path, role, rows, status

### Community 3219 - "Community 3219"
Cohesion: 0.33
Nodes (6): mt5_h4, columns, path, role, rows, status

### Community 3220 - "Community 3220"
Cohesion: 0.33
Nodes (6): mt5_m5_master, columns, path, role, rows, status

### Community 3221 - "Community 3221"
Cohesion: 0.33
Nodes (5): CorrelationNetwork, adjacency, centrality, density, nodes

### Community 3222 - "Community 3222"
Cohesion: 0.33
Nodes (5): RQAResult, determinism, entropy, laminarity, recurrence_rate

### Community 3223 - "Community 3223"
Cohesion: 0.33
Nodes (6): Feature, ic_252, name, timestamp, value, version

### Community 3224 - "Community 3224"
Cohesion: 0.33
Nodes (5): MacroData, series_id, series_name, timestamp, value

### Community 3225 - "Community 3225"
Cohesion: 0.53
Nodes (4): classify_file(), generated_path(), lower(), sample_is_binary()
...
Cohesion: 0.40
Nodes (6): baseline_model_random_forest, baseline_model_ridge, dataset_v1_feature_leakage_prevention, dataset_v1_temporal_split, report_baseline_results_v1, report_dataset_v1_manifest

### Community 3228 - "Community 3228"
Cohesion: 0.33
Nodes (6): majority_numeric, bool, numeric, string, details, passed

### Community 3229 - "Community 3229"
Cohesion: 0.33
Nodes (6): dataset_loads, details, passed, cols, memory_mb, rows

### Community 3230 - "Community 3230"
Cohesion: 0.33
Nodes (6): time_range, days, end, start, details, passed

### Community 3231 - "Community 3231"
Cohesion: 0.33
Nodes (6): m5_spacing, correct_spacing_pct, expected_seconds, large_gaps_1h+, details, passed

### Community 3232 - "Community 3232"
Cohesion: 0.47
Nodes (5): fetch_binance_daily(), fetch_ticker(), main(), Fetch cross-asset daily data from Yahoo Finance., Fetch daily klines from Binance.

### Community 3233 - "Community 3233"
Cohesion: 0.40
Nodes (5): fetch_day(), fetch_hour(), main(), Fetch one hour of ticks from Dukascopy., Fetch one day, return M5 bars or None.

### Community 3234 - "Community 3234"
Cohesion: 0.47
Nodes (4): fetch_day(), fetch_dukascopy_hour(), main(), Fetch 10 years of XAUUSD M5 data from Dukascopy.

### Community 3235 - "Community 3235"
Cohesion: 0.80
Nodes (5): supervise_tasks.sh script, check_running(), detect_tasks(), log(), monitor_tasks()

### Community 3236 - "Community 3236"
Cohesion: 0.60
Nodes (5): add(), cosine(), query(), tf(), tokenize()

### Community 3237 - "Community 3237"
Cohesion: 0.33
Nodes (5): Tests for C++ backtester parity with Python reference., C++ backtester should achieve >100k bars/s on CPU., Python and C++ backtesters must produce identical trade ledgers., test_cpp_python_trade_ledger_parity(), test_cpp_throughput()

### Community 3238 - "Community 3238"
Cohesion: 0.33
Nodes (6): Test toxicity score in [0,1]., test_toxicity_score_bounded(), compute_toxicity_score(), float, Series, Compute composite toxicity score.      Args:         vpin: Current VPIN value

### Community 3239 - "Community 3239"
Cohesion: 0.40
Nodes (5): input, format, path, rows, subsample

### Community 3240 - "Community 3240"
Cohesion: 0.40
Nodes (4): mcpServers, ragd, transport, url

### Community 3241 - "Community 3241"
Cohesion: 0.40
Nodes (5): leakage_audit, feature_count, issues, passed, target_columns

### Community 3242 - "Community 3242"
Cohesion: 0.40
Nodes (5): count, max_null_pct, mean_null_pct, nan_stats_per_family, macro

### Community 3243 - "Community 3243"
Cohesion: 0.40
Nodes (4): cpp_features, functions, role, status

### Community 3244 - "Community 3244"
Cohesion: 0.40
Nodes (5): macro_fred, path, role, series_count, status

### Community 3245 - "Community 3245"
Cohesion: 0.40
Nodes (4): JumpResult, jump_detected, jump_size, test_statistic

### Community 3248 - "Community 3248"
Cohesion: 0.60
Nodes (3): fetch(), format_date(), parse_date()

### Community 3250 - "Community 3250"
Cohesion: 0.40
Nodes (4): TensorDecomposition, entanglement_entropy, rank, singular_values

### Community 3251 - "Community 3251"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, adaptyv

### Community 3252 - "Community 3252"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, arboreto

### Community 3253 - "Community 3253"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, astropy

### Community 3254 - "Community 3254"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, autoskill

### Community 3255 - "Community 3255"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, bids

### Community 3256 - "Community 3256"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, biopython
...
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, citation-management

### Community 3260 - "Community 3260"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, clinical-decision-support

### Community 3261 - "Community 3261"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, database-lookup

### Community 3262 - "Community 3262"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, datamol

### Community 3263 - "Community 3263"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, deepchem

### Community 3264 - "Community 3264"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, deeptools

### Community 3265 - "Community 3265"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, etetoolkit

### Community 3266 - "Community 3266"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, generate-image

### Community 3267 - "Community 3267"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, get-available-resources

### Community 3268 - "Community 3268"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, ginkgo-cloud-lab

### Community 3269 - "Community 3269"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, hugging-science

### Community 3270 - "Community 3270"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, infographics

### Community 3271 - "Community 3271"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, lamindb

### Community 3272 - "Community 3272"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, markdown-mermaid-writing

### Community 3273 - "Community 3273"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, markitdown

### Community 3274 - "Community 3274"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, medchem

### Community 3275 - "Community 3275"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, molecular-dynamics

### Community 3276 - "Community 3276"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, molfeat

### Community 3277 - "Community 3277"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, neurokit2

### Community 3278 - "Community 3278"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, opentrons-integration

### Community 3279 - "Community 3279"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, paper-lookup

### Community 3280 - "Community 3280"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, parallel-web

### Community 3281 - "Community 3281"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, phylogenetics

### Community 3282 - "Community 3282"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, pptx-posters

### Community 3283 - "Community 3283"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, primekg

### Community 3284 - "Community 3284"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, anndata

### Community 3285 - "Community 3285"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, benchling-integration

### Community 3286 - "Community 3286"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, bgpt-paper-search
...
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, caveman-help
...
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, cellxgene-census

### Community 3293 - "Community 3293"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, cirq

### Community 3294 - "Community 3294"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, clinical-reports

### Community 3295 - "Community 3295"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, cobrapy

### Community 3296 - "Community 3296"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, consciousness-council

### Community 3297 - "Community 3297"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, dask

### Community 3298 - "Community 3298"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, depmap

### Community 3299 - "Community 3299"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, dhdna-profiler

### Community 3300 - "Community 3300"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, diffdock

### Community 3301 - "Community 3301"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, dnanexus-integration

### Community 3302 - "Community 3302"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, docx

### Community 3303 - "Community 3303"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, esm

### Community 3304 - "Community 3304"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, exa-search

### Community 3305 - "Community 3305"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, exploratory-data-analysis

### Community 3306 - "Community 3306"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, flowio

### Community 3307 - "Community 3307"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, fluidsim

### Community 3308 - "Community 3308"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, geniml

### Community 3309 - "Community 3309"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, geomaster

### Community 3310 - "Community 3310"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, geopandas

### Community 3311 - "Community 3311"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, gget

### Community 3312 - "Community 3312"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, glycoengineering

### Community 3313 - "Community 3313"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, gtars

### Community 3314 - "Community 3314"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, histolab

### Community 3315 - "Community 3315"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, hypogenic

### Community 3316 - "Community 3316"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, hypothesis-generation

### Community 3317 - "Community 3317"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, imaging-data-commons

### Community 3318 - "Community 3318"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, iso-13485-certification

### Community 3319 - "Community 3319"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, labarchive-integration

### Community 3320 - "Community 3320"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, latchbio-integration

### Community 3321 - "Community 3321"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, latex-posters

### Community 3322 - "Community 3322"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, literature-review

### Community 3323 - "Community 3323"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, market-research-reports

### Community 3324 - "Community 3324"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, matchms

### Community 3325 - "Community 3325"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, matlab

### Community 3326 - "Community 3326"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, matplotlib

### Community 3327 - "Community 3327"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, modal

### Community 3328 - "Community 3328"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, networkx

### Community 3329 - "Community 3329"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, neuropixels-analysis

### Community 3330 - "Community 3330"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, omero-integration

### Community 3331 - "Community 3331"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, open-notebook

### Community 3332 - "Community 3332"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, optimize-for-gpu

### Community 3333 - "Community 3333"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, paperzilla

### Community 3334 - "Community 3334"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, pathml

### Community 3335 - "Community 3335"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, pdf

### Community 3336 - "Community 3336"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, peer-review

### Community 3337 - "Community 3337"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, pennylane

### Community 3338 - "Community 3338"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, polars

### Community 3339 - "Community 3339"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, polars-bio

### Community 3340 - "Community 3340"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, pptx

### Community 3341 - "Community 3341"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, protocolsio-integration

### Community 3342 - "Community 3342"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, pufferlib

### Community 3343 - "Community 3343"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, pydeseq2

### Community 3344 - "Community 3344"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, pydicom

### Community 3345 - "Community 3345"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, pyhealth

### Community 3346 - "Community 3346"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, pylabrobot

### Community 3347 - "Community 3347"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, pymatgen

### Community 3348 - "Community 3348"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, aeon

### Community 3349 - "Community 3349"
Cohesion: 0.40
Nodes (4): init_exec_sim_schema(), Path, DuckDB schema for execution simulator., Initialize execution simulator tables.      Args:         db_path: Path to DuckD

### Community 3351 - "Community 3351"
Cohesion: 0.80
Nodes (4): compute_emd(), find_extrema(), interpolate_envelope(), sift()

### Community 3352 - "Community 3352"
Cohesion: 0.50
Nodes (3): helper(), Greeter, str

### Community 3353 - "Community 3353"
Cohesion: 0.40
Nodes (5): label_balance, type, unique_values, details, passed

### Community 3354 - "Community 3354"
Cohesion: 0.40
Nodes (4): dataset, issues, timestamp, verdict

### Community 3355 - "Community 3355"
Cohesion: 0.60
Nodes (4): main(), int, str, query()

### Community 3356 - "Community 3356"
Cohesion: 0.40
Nodes (4): compute_classification_metrics(), compute_trading_metrics(), Compute trading metrics with costs., Compute classification metrics.

### Community 3357 - "Community 3357"
Cohesion: 0.80
Nodes (4): keepalive_supervisor.sh script, is_supervisor_running(), log(), start_supervisor()

### Community 3358 - "Community 3358"
Cohesion: 0.60
Nodes (3): cache_valid(), fetch(), parse_date()

### Community 3359 - "Community 3359"
Cohesion: 0.60
Nodes (3): exec_command(), fetch(), parse_unix()

### Community 3360 - "Community 3360"
Cohesion: 0.40
Nodes (4): init_exec_features_schema(), Path, DuckDB schema for execution features., Initialize execution features tables.      Args:         db_path: Path to DuckDB

### Community 3361 - "Community 3361"
Cohesion: 0.40
Nodes (4): compute_trade_features(), DataFrame, Trade pattern features (10)., Compute 10 trade pattern features.      Args:         df: DataFrame with trade d

### Community 3362 - "Community 3362"
Cohesion: 0.40
Nodes (4): init_toxicity_schema(), Path, DuckDB schema for toxicity monitor., Initialize toxicity tables.      Args:         db_path: Path to DuckDB database

### Community 3363 - "Community 3363"
Cohesion: 0.40
Nodes (4): created_at, name, repo_root, version

### Community 3364 - "Community 3364"
Cohesion: 0.50
Nodes (4): completed_code_changes, built, created, modified

### Community 3365 - "Community 3365"
Cohesion: 0.50
Nodes (4): features_added, count, families, list

### Community 3366 - "Community 3366"
Cohesion: 0.50
Nodes (4): output, format, path, status

### Community 3367 - "Community 3367"
Cohesion: 0.50
Nodes (4): pending_tasks, after_validation, immediate, never

### Community 3368 - "Community 3368"
Cohesion: 0.50
Nodes (4): BenchResult, register_suite, _run_foundation_suite, run_suite

### Community 3369 - "Community 3369"
Cohesion: 0.83
Nodes (3): numpy_to_pricevec(), pricevec_to_numpy(), PYBIND11_MODULE()

### Community 3370 - "Community 3370"
Cohesion: 0.50
Nodes (3): ScopedTimer, name, start

### Community 3372 - "Community 3372"
Cohesion: 0.50
Nodes (4): count, max_null_pct, mean_null_pct, cross_timeframe

### Community 3373 - "Community 3373"
Cohesion: 0.50
Nodes (4): count, max_null_pct, mean_null_pct, interactions

### Community 3374 - "Community 3374"
Cohesion: 0.50
Nodes (4): count, max_null_pct, mean_null_pct, entropy_fractal

### Community 3375 - "Community 3375"
Cohesion: 0.50
Nodes (4): count, max_null_pct, mean_null_pct, microstructure

### Community 3376 - "Community 3376"
Cohesion: 0.50
Nodes (4): return, count, max_null_pct, mean_null_pct

### Community 3377 - "Community 3377"
Cohesion: 0.50
Nodes (4): session_calendar, count, max_null_pct, mean_null_pct

### Community 3378 - "Community 3378"
Cohesion: 0.50
Nodes (4): trend_momentum, count, max_null_pct, mean_null_pct

### Community 3379 - "Community 3379"
Cohesion: 0.50
Nodes (4): other, count, max_null_pct, mean_null_pct

### Community 3380 - "Community 3380"
Cohesion: 0.50
Nodes (4): targets, count, max_null_pct, mean_null_pct

### Community 3381 - "Community 3381"
Cohesion: 0.50
Nodes (4): volatility, count, max_null_pct, mean_null_pct

### Community 3385 - "Community 3385"
Cohesion: 0.50
Nodes (3): ComplexityEntropyPoint, complexity, entropy

### Community 3386 - "Community 3386"
Cohesion: 0.50
Nodes (4): dominion_loader_cache_class, dominion_loader_cache_corruption_exception, dominion_loader_cache_hit_class, dominion_loader_tests_cache

### Community 3387 - "Community 3387"
Cohesion: 0.50
Nodes (4): dominion_loader_chunking_hooks_chunk_class, dominion_loader_chunking_hooks_chunker_for_fn, dominion_loader_chunking_hooks_register_fn, dominion_loader_tests_chunking_hooks

### Community 3388 - "Community 3388"
Cohesion: 0.83
Nodes (4): ingest_from_ragd, KGEdge, KGNode, KnowledgeGraph

### Community 3389 - "Community 3389"
Cohesion: 0.50
Nodes (4): hash_file, HashResult, PriorEntry, _sha256_file

### Community 3391 - "Community 3391"
Cohesion: 0.83
Nodes (3): verify_live.sh script, check(), warn_check()

### Community 3392 - "Community 3392"
Cohesion: 0.50
Nodes (4): _gpu_info, hw_probe, hw_probe_json, _ram_bytes

### Community 3393 - "Community 3393"
Cohesion: 0.50
Nodes (3): bool, is_stalled(), ETA engine — rolling throughput estimation.

### Community 3397 - "Community 3397"
Cohesion: 0.50
Nodes (3): ragd.sh script, RAGD_ENDPOINT, RAGD_SOCKET

### Community 3398 - "Community 3398"
Cohesion: 0.83
Nodes (3): has_flag(), main(), value_after()
...
Cohesion: 0.50
Nodes (4): time_column_exists, column, details, passed

### Community 3402 - "Community 3402"
Cohesion: 0.50
Nodes (4): no_duplicate_timestamps, duplicates, details, passed

### Community 3403 - "Community 3403"
Cohesion: 0.50
Nodes (4): no_label_leakage, leaked_columns, details, passed

### Community 3404 - "Community 3404"
Cohesion: 0.50
Nodes (4): time_column_dtype, dtype, details, passed

### Community 3407 - "Community 3407"
Cohesion: 0.83
Nodes (3): setup_env.sh script, prompt(), set_env()

### Community 3408 - "Community 3408"
Cohesion: 0.67
Nodes (3): load_results(), main(), str

### Community 3410 - "Community 3410"
Cohesion: 0.83
Nodes (3): verify_source.sh script, check(), warn_check()

### Community 3412 - "Community 3412"
Cohesion: 0.83
Nodes (3): expand_user(), main(), value_after()

### Community 3413 - "Community 3413"
Cohesion: 0.67
Nodes (3): Chunk, chunker_for, register_chunker

### Community 3418 - "Community 3418"
Cohesion: 0.67
Nodes (3): dominion_loader_ledger_class, dominion_loader_ledger_valid_kinds, dominion_loader_tests_ledger

### Community 3419 - "Community 3419"
Cohesion: 0.67
Nodes (3): dominion_loader_classify_fn, dominion_loader_is_likely_binary_fn, dominion_loader_tests_classify

### Community 3423 - "Community 3423"
Cohesion: 0.67
Nodes (3): stability_analysis, best_is_isolated, neighboring_thresholds_checked
...
## Knowledge Gaps
- **27322 isolated node(s):** `version`, `source`, `sourceType`, `skillPath`, `computedHash` (+27317 more)
...
- **Why does `Ignore` connect `Loader Discovery System` to `Community 98`, `Test Infrastructure`, `Community 46`, `Community 55`, `Community 123`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **Why does `policy_hash()` connect `Community 46` to `Community 50`, `Test Infrastructure`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **Are the 49 inferred relationships involving `Manifest` (e.g. with `BenchResult` and `float`) actually correct?**
  _`Manifest` has 49 INFERRED edges - model-reasoned connections that need verification._
- **Are the 40 inferred relationships involving `ScoredChunk` (e.g. with `str` and `ScoredChunk`) actually correct?**
  _`ScoredChunk` has 40 INFERRED edges - model-reasoned connections that need verification._
- **Are the 41 inferred relationships involving `Ignore` (e.g. with `BenchResult` and `float`) actually correct?**
  _`Ignore` has 41 INFERRED edges - model-reasoned connections that need verification._
- **What connects `version`, `source`, `sourceType` to the rest of the system?**
  _28789 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Hydra CLI Commands` be split into smaller, more focused modules?**
  _Cohesion score 0.021676038454561945 - nodes in this community are weakly interconnected._
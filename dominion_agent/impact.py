...
_RULES: list[_Rule] = [
    ...
    _Rule(
        ...
        package="ragd_embed",
        risk="medium",
        required=["python -m pytest -q ragd_embed/tests"],
        optional=["dominion embed doctor --json || true"],
        tests=["ragd_embed/tests/"],
    ),
    _Rule(
        prefix="ragd_hnsw/",
        package="ragd_hnsw",
        risk="medium",
        required=["python -m pytest -q ragd_hnsw/tests"],
        optional=["dominion embed stats --json || true"],
        tests=["ragd_hnsw/tests/"],
    ),
    _Rule(
        prefix="ragd_chunker/",
        package="ragd_chunker",
        risk="medium",
        required=["python -m pytest -q ragd_chunker/tests"],
        optional=["python -m ragd_chunker.service --check || true"],
        tests=["ragd_chunker/tests/"],
    ),
    _Rule(
        prefix="ragd_vault/",
        package="ragd_vault",
        risk="medium",
        required=["python -m pytest -q ragd_vault/tests"],
        optional=["dominion vault doctor --json || true"],
        tests=["ragd_vault/tests/"],
    ),
    _Rule(
        prefix="ragd/",
        package="ragd",

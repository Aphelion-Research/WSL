"""Scalp brain — M1/M5 timeframe specialisation."""
...
class ScalpBrain:
    """M1/M5 fast-timeframe brain with all 12 base learners."""
    ...
    def __init__(self):
        ...
        self.val_sharpes: Optional[np.ndarray] = None
    ...
    def set_bma_weights(self, val_sharpes: np.ndarray):
        self.val_sharpes = val_sharpes
        self.bma_w = bma_weights(val_sharpes)

    def predict(self, X: np.ndarray) -> tuple[np.ndarray, np.ndarray]:
        """Returns (signals, confidences)."""
